...
namespace Regul.Base.Other
{
    ...
    public static class Extensions
    {
        ...
        /// </summary>
        public static T Bind<T>(this IAvaloniaObject control, AvaloniaProperty property, IBinding binding,
            object anchor = null)
        {
            ...
            Overwrite overwriteMethod = Overwrite.IfNewer)
        {
            ...
            switch (overwriteMethod)
            {
                ...
                case Overwrite.Never:
                    ...
                    if (!File.Exists(destinationFileName)) file.ExtractToFile(destinationFileName);
                    break;
            }
        }
