...
namespace Onebeld.Plugins.Loader
{
    ...
    public class AssemblyLoadContextBuilder
    {
        ...
        private readonly Dictionary<string, ManagedLibrary> _managedLibraries =
            new Dictionary<string, ManagedLibrary>(StringComparer.Ordinal);

        private readonly Dictionary<string, NativeLibrary> _nativeLibraries =
            new Dictionary<string, NativeLibrary>(StringComparer.Ordinal);
