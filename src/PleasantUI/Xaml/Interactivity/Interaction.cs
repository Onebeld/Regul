...
public class Interaction
{
    ...
    public static BehaviorCollection GetBehaviors(IAvaloniaObject obj)
    {
        ...
        object? behaviorCollection = obj.GetValue(BehaviorsProperty);
        ...
        return (BehaviorCollection)behaviorCollection;
    }
    ...
    {
        BehaviorCollection? oldCollection = e.OldValue.GetValueOrDefault();
        BehaviorCollection? newCollection = e.NewValue.GetValueOrDefault();
