...
{
    private static readonly Lazy<ColorToHexConverter> Lazy = new(() => new ColorToHexConverter());
    ...
    public object ConvertBack(object? value, Type targetType, object? parameter, CultureInfo culture)
    {
        ...
        if (hexValue.StartsWith("#", StringComparison.Ordinal) == false && Color.TryParse("#" + hexValue, out Color color2))
            return color2;
