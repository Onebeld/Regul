...
namespace Regul.S3PI.Interfaces
{
        ...
        where T : struct, IComparable, IConvertible, IEquatable<T>, IComparable<T>
    {
        ...
        {
            DependentList<HandlerElement<TU>> _list;
            DependentList<HandlerElement<TU>>.Enumerator _enumerator;

            internal Enumerator(DependentList<HandlerElement<TU>> list) { _list = list; Reset(); }

            /// <summary>
            /// Gets the element at the current position of the enumerator.
            /// </summary>
            public TU Current => _enumerator.Current;
        ...
        public SimpleList(EventHandler handler, CreateElementMethod createElement = null, WriteElementMethod writeElement = null, long size = -1, ReadCountMethod readCount = null, WriteCountMethod writeCount = null) : base(handler, size) { _createElement = createElement; _writeElement = writeElement; _readCount = readCount; _writeCount = writeCount; }
        /// <summary>
        /// Initializes a new instance of the <see cref="SimpleList{T}"/> class
        ...
        protected override HandlerElement<T> CreateElement(Stream s) { return new HandlerElement<T>(elementHandler, _createElement == null ? default(T) : _createElement(s)); }
        /// <summary>
        ...
        {
            _writeElement?.Invoke(s, element.Val);
        }
        #endregion
        ...
        public override void Add() { Add(default(T)); }
        #endregion
        ...
        class SimpleComparer : IComparer<HandlerElement<T>>
        {
            ...
            public int Compare(HandlerElement<T> x, HandlerElement<T> y) { return _comparer.Compare(x.Val, y.Val); }
        }
        #endregion
        ...
        /// <exception cref="System.NotSupportedException">The <see cref="SimpleList{T}"/> is read-only.</exception>
        public new virtual T this[int index] { get => base[index].Val;
            set { if (!base[index].Val.Equals(value)) { base[index].Val = value; OnListChanged(); } } }
