...
namespace Regul.S3PI.Interfaces
{
    ...
    {
        bool _dataGridExpandable;
        /// <summary>
        /// Indicates that the element should be expandable rather than requiring a popup
        /// </summary>
        public DataGridExpandableAttribute() { _dataGridExpandable = true; }
        /// <summary>
        ...
        public DataGridExpandableAttribute(bool value) { _dataGridExpandable = value; }
        /// <summary>
        /// Indicate whether the element should be expandable (true) or not (false)
        /// </summary>
        public bool DataGridExpandable { get => _dataGridExpandable;
            set => _dataGridExpandable = value;
        }
        ...
        public static bool GetDataGridExpandable(Type t, string index)
        {
            ...
            if (pi != null)
                foreach (object attr in pi.GetCustomAttributes(typeof(DataGridExpandableAttribute), true))
