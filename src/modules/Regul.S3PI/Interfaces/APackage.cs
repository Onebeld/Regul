...
namespace Regul.S3PI.Interfaces
{
    ...
    public abstract class APackage : AApiVersionedFields, IPackage
    {
        ...
        public static IPackage NewPackage() { throw new NotImplementedException(); }
        /// <summary>
        ...
        public static IPackage OpenPackage(string packagePath) { throw new NotImplementedException(); }
        /// <summary>
        ...
        /// <returns>IPackage reference to an existing package on disk</returns>
        public static IPackage OpenPackage(string packagePath, bool readwrite) { throw new NotImplementedException(); }
        /// <summary>
        /// Releases any internal references associated with the given package
        /// </summary>
        /// <param name="pkg">IPackage reference to close</param>
        public static void ClosePackage(IPackage pkg) { throw new NotImplementedException(); }
