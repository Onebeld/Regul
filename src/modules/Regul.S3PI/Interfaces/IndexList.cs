...
namespace Regul.S3PI.Interfaces
{
        ...
        where T : struct, IComparable, IConvertible, IEquatable<T>, IComparable<T>
    {
        ...
        public DependentList<TGIBlock> ParentTGIBlocks
        {
            ...
            set { if (_parentTgiBlocks != value) { _parentTgiBlocks = value; foreach (TGIBlockListIndex<T> i in this as DependentList<TGIBlockListIndex<T>>) i.ParentTGIBlocks = _parentTgiBlocks; } }
        }

        #region Attributes
        CreateElementMethod _createElement;
        WriteElementMethod _writeElement;
        ReadCountMethod _readCount;
        WriteCountMethod _writeCount;
        #endregion
        ...
        public class Enumerator<TU> : IEnumerator<TU>
            where TU : struct, IComparable, IConvertible, IEquatable<TU>, IComparable<TU>
        {
            DependentList<TGIBlockListIndex<TU>> _list;
            DependentList<TGIBlockListIndex<TU>>.Enumerator _enumerator;

            internal Enumerator(DependentList<TGIBlockListIndex<TU>> list) { _list = list; Reset(); }

            /// <summary>
            /// Gets the element at the current position of the enumerator.
            /// </summary>
            public TU Current => _enumerator.Current.Data;
            ...
            object System.Collections.IEnumerator.Current => _enumerator.Current.Data;
            ...
            /// </summary>
            /// <exception cref="System.InvalidOperationException">The collection was modified after the enumerator was created.</exception>
            public void Reset() { _enumerator = _list.GetEnumerator(); }
        }
        #endregion
        ...
        public IndexList(EventHandler handler, CreateElementMethod createElement = null, WriteElementMethod writeElement = null, long size = -1, ReadCountMethod readCount = null, WriteCountMethod writeCount = null, DependentList<TGIBlock> parentTgiBlocks = null)
            : base(handler, size) { _parentTgiBlocks = parentTgiBlocks; _createElement = createElement; _writeElement = writeElement; _readCount = readCount; _writeCount = writeCount; }
        /// <summary>
        /// Initializes a new instance of the <see cref="IndexList{T}"/> class
        ...
        public IndexList(EventHandler handler, IEnumerable<T> collection, CreateElementMethod createElement = null, WriteElementMethod writeElement = null, long size = -1, ReadCountMethod readCount = null, WriteCountMethod writeCount = null, DependentList<TGIBlock> parentTgiBlocks = null)
            : this(null, createElement, writeElement, size, readCount, writeCount, parentTgiBlocks) { elementHandler = handler; AddRange(collection); this.handler = handler; }
        /// <summary>
        ...
        protected override int ReadCount(Stream s) { return _readCount == null ? base.ReadCount(s) : _readCount(s); }
        /// <summary>
        ...
        protected override void WriteCount(Stream s, int count) { if (_writeCount == null) base.WriteCount(s, count); else _writeCount(s, count); }
        ...
        protected override TGIBlockListIndex<T> CreateElement(Stream s) { return new TGIBlockListIndex<T>(elementHandler, _createElement == null ? default(T) : _createElement(s), _parentTgiBlocks); }
        /// <summary>
        ...
        {
            _writeElement?.Invoke(s, element.Data);
        }
        #endregion
        ...
        public override void Add() { Add(new TGIBlockListIndex<T>(elementHandler, default(T), _parentTgiBlocks)); }
        #endregion
        ...
        /// </exception>
        public int BinarySearch(T item) { return BinarySearch(item, null); }
        /// <summary>
        ///     Searches a the entire sorted <see cref="IndexList{T}"/>
        ...
        ///     or the <see cref="System.IComparable"/> interface for type T.
        /// </exception>
        public int BinarySearch(T item, IComparer<T> comparer) { return BinarySearch(0, Count, item, comparer); }
        /// <summary>
        ...
        ///     <paramref name="match"/> is null.
        /// </exception>
        public int FindIndex(Predicate<T> match) { return FindIndex(0, Count, match); }
        /// <summary>
        ///     Searches for an element that matches the conditions defined by the specified
        ///     predicate, and returns the zero-based index of the first occurrence within
        ...
        /// </exception>
        public int FindIndex(int startIndex, Predicate<T> match) { return FindIndex(startIndex, Count - startIndex, match); }
        /// <summary>
        ///     Searches for an element that matches the conditions defined by the specified
        ///     predicate, and returns the zero-based index of the first occurrence within
        ...
        /// </exception>
        public int FindIndex(int startIndex, int count, Predicate<T> match) { return IndexOf(Find(match), startIndex, count); }
        /// <summary>
        ///     Searches for an element that matches the conditions defined by the specified
        ...
        ///     <paramref name="match"/> is null.
        /// </exception>
        public int FindLastIndex(Predicate<T> match) { return FindLastIndex(0, Count, match); }
        /// <summary>
        ///     Searches for an element that matches the conditions defined by the specified
        ///     predicate, and returns the zero-based index of the last occurrence within
        ...
        ///     <paramref name="startIndex"/> is outside the range of valid indexes for the <see cref="IndexList{T}"/>.
        /// </exception>
        public int FindLastIndex(int startIndex, Predicate<T> match) { return FindLastIndex(startIndex, Count - startIndex, match); }
        /// <summary>
        ///     Searches for an element that matches the conditions defined by the specified
        ///     predicate, and returns the zero-based index of the last occurrence within
        ///     the range of elements in the <see cref="IndexList{T}"/> that
        ...
        ///     <paramref name="startIndex"/> and <paramref name="count"/> do not specify a valid section in the <see cref="IndexList{T}"/>.
        /// </exception>
        public int FindLastIndex(int startIndex, int count, Predicate<T> match) { return LastIndexOf(FindLast(match), startIndex, count); }
        ...
        /// </exception>
        public int IndexOf(T item, int index) { return IndexOf(item, index, Count - index); }
        /// <summary>
        ///     Searches for the specified object and returns the zero-based index of the
        ///     first occurrence within the range of elements in the <see cref="IndexList{T}"/>
        ...
        ///     if found; otherwise, –1.
        /// </returns>
        public int LastIndexOf(T item) { return LastIndexOf(item, Count - 1, Count); }
        /// <summary>
        ///     Searches for the specified object and returns the zero-based index of the
        ...
        ///     index is outside the range of valid indexes for the <see cref="IndexList{T}"/>.
        /// </exception>
        public int LastIndexOf(T item, int index) { return LastIndexOf(item, index, index + 1); }
        /// <summary>
        ///     Searches for the specified object and returns the zero-based index of the
        ///     last occurrence within the range of elements in the <see cref="IndexList{T}"/>
        ...
        public virtual bool Remove(T item) { int index = IndexOf(item); if (index < 0) return false; RemoveAt(index); return true; }
        /// <summary>
        ...
        /// </exception>
        /// <exception cref="System.NotSupportedException">The <see cref="IndexList{T}"/> is read-only.</exception>
        public virtual void Sort(IComparer<T> comparer) { if (comparer != null) Sort(comparer.Compare); else Sort(); }
        /// <summary>
        ...
        {
            IComparer<T> _comparer; public SimpleComparer(IComparer<T> comparer) { _comparer = comparer != null ? comparer : Comparer<T>.Default; }
            public int Compare(TGIBlockListIndex<T> x, TGIBlockListIndex<T> y) { return _comparer.Compare(x.Data, y.Data); }
        }
        #endregion
        ...
        /// <exception cref="System.NotSupportedException">The <see cref="IndexList{T}"/> is read-only.</exception>
        public new virtual T this[int index] { get => base[index].Data;
            set { if (!base[index].Data.Equals(value)) { base[index].Data = value; OnListChanged(); } } }
        ...
        ///     if found; otherwise, –1.
        /// </returns>
        public int IndexOf(T item) { return IndexOf(item, 0, Count); }
        /// <summary>
