...
namespace Regul.S3PI.Resources.RCOLChunks
{
    public class VPXY : ARCOLBlock
    {
        ...
        #region Constructors
        public VPXY(EventHandler handler) : base(handler, null) { }
        public VPXY(EventHandler handler, Stream s) : base(handler, s) { }
        public VPXY(EventHandler handler, VPXY basis)
            : this(handler,
        ...
        protected override void Parse(Stream s)
        {
            ...
            bounds = new BoundingBox(handler, s);
        ...
        public override Stream UnParse()
        {
            ...
            if (bounds == null) bounds = new BoundingBox(handler);
            bounds.UnParse(ms);
        ...
        public abstract class Entry : AHandlerElement, IEquatable<Entry>
        {
            ...
            #region Constructors
            protected Entry(EventHandler handler) : base(handler) { }
            ...
            public static Entry CreateEntry(EventHandler handler, Stream s, DependentList<TGIBlock> ParentTGIBlocks)
            {
                ...
                if (entryType == 0x00) return new Entry00(handler, 0, r.ReadByte(), s, ParentTGIBlocks);
                if (entryType == 0x01) return new Entry01(handler, 1, r.ReadInt32(), ParentTGIBlocks);
        ...
        public class Entry00 : Entry
        {
            ...
            public Entry00(EventHandler handler, DependentList<TGIBlock> ParentTGIBlocks = null)
                : this(handler, 0, 0, new Int32IndexList(null), ParentTGIBlocks) { }
            public Entry00(EventHandler handler, Entry00 basis, DependentList<TGIBlock> ParentTGIBlocks = null)
                : this(handler, 0, basis.entryID, basis.tgiIndexes, ParentTGIBlocks ?? basis._ParentTGIBlocks) { }
            public Entry00(EventHandler handler, byte entryType, byte entryID, Stream s,
                DependentList<TGIBlock> ParentTGIBlocks = null)
                : base(handler) { _ParentTGIBlocks = ParentTGIBlocks; this.entryID = entryID; this.tgiIndexes = new Int32IndexList(handler, s, byte.MaxValue, ReadByte, WriteByte, _ParentTGIBlocks); }
            public Entry00(EventHandler handler, byte entryType, byte entryID, IEnumerable<int> tgiIndexes,
                DependentList<TGIBlock> ParentTGIBlocks = null)
                : base(handler) { _ParentTGIBlocks = ParentTGIBlocks; this.entryID = entryID; this.tgiIndexes = new Int32IndexList(handler, tgiIndexes, byte.MaxValue, ReadByte, WriteByte, _ParentTGIBlocks); }
        ...
        public class Entry01 : Entry
        {
            ...
            int tgiIndex;
            public Entry01(EventHandler handler, DependentList<TGIBlock> ParentTGIBlocks = null)
                : this(handler, 1, 0, ParentTGIBlocks) { }
            public Entry01(EventHandler handler, Entry01 basis, DependentList<TGIBlock> ParentTGIBlocks = null)
                : this(handler, 1, basis.tgiIndex, ParentTGIBlocks ?? basis.ParentTGIBlocks) { }
            public Entry01(EventHandler handler, byte entryType, int tgiIndex,
                DependentList<TGIBlock> ParentTGIBlocks = null)
                : base(handler) { this.ParentTGIBlocks = ParentTGIBlocks; this.tgiIndex = tgiIndex; }
            internal override void UnParse(Stream s)
            {
                BinaryWriter w = new BinaryWriter(s);
                w.Write((byte)0x01);
        ...
        public class EntryList : DependentList<Entry>
        {
            ...
            protected override Entry CreateElement(Stream s) { return Entry.CreateEntry(elementHandler, s, ParentTGIBlocks); }
            ...
            public override void Add(Type elementType)
            {
                ...
                Entry newElement = Activator.CreateInstance(elementType, new object[] { elementHandler, _ParentTGIBlocks, }) as Entry;
                base.Add(newElement);
            }
        }
        #endregion
        ...
        public BoundingBox Bounds
        {
            ...
            set
            {
                if (bounds != value) { bounds = new BoundingBox(handler, value); OnRCOLChanged(this, EventArgs.Empty); }
            }
        }
        [ElementPriority(15)]
        public byte[] Unused
        {
            ...
            set
            {
                ...
                if (!unused.Equals(value)) { unused = value == null ? null : (byte[])value.Clone(); OnRCOLChanged(this, EventArgs.Empty); }
            }
        }
        [ElementPriority(16)]
