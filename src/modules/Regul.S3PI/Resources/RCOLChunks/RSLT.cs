...
namespace Regul.S3PI.Resources.RCOLChunks
{
    public class RSLT : ARCOLBlock
    {
        ...
        #region Constructors
        public RSLT(EventHandler handler) : base(handler, null) { }
        public RSLT(EventHandler handler, Stream s) : base(handler, s) { }
        public RSLT(EventHandler handler, RSLT basis)
            : base(handler, null)
        {
        ...
        public class SlotOffset : AHandlerElement, IEquatable<SlotOffset>
        {
            ...
            #region Constructors
            public SlotOffset(EventHandler handler)
                : this(handler, -1, new Vertex(null), new Vertex(null)) { }
            public SlotOffset(EventHandler handler, SlotOffset basis)
                : this(handler, basis.slotIndex, basis.position, basis.rotation) { }
            public SlotOffset(EventHandler handler,
                int slotIndex, Vertex position, Vertex rotation)
                : base(handler)
            {
                this.slotIndex = slotIndex;
                this.position = new Vertex(handler, position);
                this.rotation = new Vertex(handler, rotation);
            }
            public SlotOffset(EventHandler handler, Stream s) : base(handler) { Parse(s); }
            #endregion
            ...
            void Parse(Stream s)
            {
                ...
                position = new Vertex(handler, s);
                rotation = new Vertex(handler, s);
            }
            ...
            internal void UnParse(Stream s)
            {
                ...
                w.Write(slotIndex);
                if (position == null) position = new Vertex(handler);
                position.UnParse(s);
                if (rotation == null) rotation = new Vertex(handler);
                rotation.UnParse(s);
            }
            #endregion
        ...
        public class SlotOffsetList : DependentList<SlotOffset>
        {
            ...
            #region Data I/O
            protected override SlotOffset CreateElement(Stream s) { return new SlotOffset(elementHandler, s); }
        ...
        public class TransformElement : AHandlerElement, IEquatable<TransformElement>
        {
            ...
            #region Constructors
            public TransformElement(EventHandler handler) : base(handler) { }
            public TransformElement(EventHandler handler, TransformElement basis)
                : this(handler, basis.rot1, basis.rot2, basis.rot3, basis.pos) { }
            public TransformElement(EventHandler handler, float rot1, float rot2, float rot3, float pos)
                : base(handler) { this.rot1 = rot1; this.rot2 = rot2; this.rot3 = rot3; this.pos = pos; }
            public TransformElement(EventHandler handler, Stream s) : base(handler) { Parse(s); }
            #endregion
        ...
        public class Part : AHandlerElement, IEquatable<Part>
        {
            ...
            public Part(EventHandler handler, Part basis)
                : this(handler, basis.slotName, basis.boneName, basis.tX, basis.tY, basis.tZ) { }
            public Part(EventHandler handler,
            ...
            [ElementPriority(4)]
            public TransformElement X { get { return tX; } set { if (tX != value) { tX = new TransformElement(handler, value); OnElementChanged(); } } }
            [ElementPriority(5)]
            public TransformElement Y { get { return tY; } set { if (tY != value) { tY = new TransformElement(handler, value); OnElementChanged(); } } }
            [ElementPriority(6)]
            public TransformElement Z { get { return tZ; } set { if (tZ != value) { tZ = new TransformElement(handler, value); OnElementChanged(); } } }
        ...
        public class PartList : DependentList<Part>
        {
            ...
            protected void Parse(Stream s, int count)
            {
                ...
                for (int i = 0; i < count; i++) this.Add(new Part(elementHandler, slotNames[i], boneNames[i],
                    new TransformElement(elementHandler, s), new TransformElement(elementHandler, s), new TransformElement(elementHandler, s)));
            }
            public override void UnParse(Stream s)
            {
                ...
                {
                    if (this[i].X == null) this[i].X = new TransformElement(handler);
                    this[i].X.UnParse(s);
                    if (this[i].Y == null) this[i].Y = new TransformElement(handler);
                    this[i].Y.UnParse(s);
                    if (this[i].Z == null) this[i].Z = new TransformElement(handler);
                    this[i].Z.UnParse(s);
                }
            }
        ...
        public class SlottedPart : Part, IEquatable<SlottedPart>
        {
            ...
            public SlottedPart(EventHandler handler) : base(handler) { }
            public SlottedPart(EventHandler handler, SlottedPart basis) : base(handler, basis) { slotPlacementFlags = basis.slotPlacementFlags; }
            public SlottedPart(EventHandler handler, uint slotName, uint boneName, SlotPlacement slotPlacementFlags,
                TransformElement tX, TransformElement tY, TransformElement tZ)
                : base(handler, slotName, boneName, tX, tY, tZ) { this.slotPlacementFlags = slotPlacementFlags; }
        ...
        public class SlottedPartList : DependentList<SlottedPart>
        {
            ...
            protected void Parse(Stream s, int count)
            {
                ...
                for (int i = 0; i < count; i++) this.Add(new SlottedPart(elementHandler, slotNames[i], boneNames[i], (SlotPlacement)flags[i],
                    new TransformElement(elementHandler, s), new TransformElement(elementHandler, s), new TransformElement(elementHandler, s)));
            }
            public override void UnParse(Stream s)
            {
        ...
        public class ConeElement : AHandlerElement, IEquatable<ConeElement>
        {
            ...
            #region Constructors
            public ConeElement(EventHandler handler) : base(handler) { }
            public ConeElement(EventHandler handler, ConeElement basis)
                : this(handler, basis.radius, basis.angle) { }
            public ConeElement(EventHandler handler, float radius, float angle)
                : base(handler)
            {
                this.radius = radius;
                this.angle = angle;
            }
            public ConeElement(EventHandler handler, Stream s) : base(handler) { Parse(s); }
            #endregion
        ...
        public class ConePart : AHandlerElement, IEquatable<ConePart>
        {
            ...
            public ConePart(EventHandler handler, ConePart basis)
                : this(handler, basis.slotName, basis.boneName, basis.tX, basis.tY, basis.tZ, basis.cone) { }
            public ConePart(EventHandler handler,
                uint slotName, uint boneName, TransformElement tX, TransformElement tY, TransformElement tZ,
                ConeElement cone)
                : base(handler)
            ...
            public TransformElement Z { get { return tZ; } set { if (tZ != value) { tZ = new TransformElement(handler, value); OnElementChanged(); } } }
            [ElementPriority(7)]
            public ConeElement Cone { get { return cone; } set { if (cone != value) { cone = new ConeElement(handler, value); OnElementChanged(); } } }
        ...
        public class ConePartList : DependentList<ConePart>
        {
            ...
            protected void Parse(Stream s, int count)
            {
                ...
                for (int i = 0; i < transformElements.Length; i++)
                {
                    ...
                    transformElements[i][0] = new TransformElement(elementHandler, s);//X
                    transformElements[i][1] = new TransformElement(elementHandler, s);//Y
                    transformElements[i][2] = new TransformElement(elementHandler, s);//Z
                }
                for (int i = 0; i < coneElements.Length; i++) coneElements[i] = new ConeElement(elementHandler, s);

                for (int i = 0; i < count; i++) this.Add(new ConePart(elementHandler, slotNames[i], boneNames[i],
            ...
            public override void UnParse(Stream s)
            {
                ...
                for (int i = 0; i < Count; i++)
                {
                    if (this[i].Cone == null) this[i].Cone = new ConeElement(handler);
