...
namespace Regul.S3PI.Resources.RCOLChunks
{
    public class MTNF : AHandlerElement, IEquatable<MTNF>, IResource
    {
        ...
        public MTNF(EventHandler handler, MTNF basis)
            : base(handler)
        {
        ...
        public MTNF(EventHandler handler, Stream s, string _RCOLTag = "MATD") : base(handler) { this._RCOLTag = _RCOLTag; Parse(s); }
        public MTNF(EventHandler handler, string _RCOLTag = "MATD") : base(handler) { this._RCOLTag = _RCOLTag; }
