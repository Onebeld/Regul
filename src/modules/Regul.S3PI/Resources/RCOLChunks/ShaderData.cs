...
namespace Regul.S3PI.Resources.RCOLChunks
{
    ...
    public abstract class ShaderData : AHandlerElement, IEquatable<ShaderData>
    {
        ...
        #region Constructors
        protected ShaderData(EventHandler handler, FieldType field) : base(handler) { this.field = field; }
        #endregion
    ...
    public class ElementFloat : ShaderData
    {
        ...
        #region Constructors
        public ElementFloat(EventHandler handler, FieldType field, Stream s) : base(handler, field) { Parse(s); }
        public ElementFloat(EventHandler handler) : this(handler, (FieldType)0, 0f) { }
        public ElementFloat(EventHandler handler, ElementFloat basis) : this(handler, basis.field, basis.data) { }
        public ElementFloat(EventHandler handler, FieldType field, float data) : base(handler, field) { this.data = data; }
        #endregion
    ...
    public class ElementFloat2 : ShaderData
    {
        ...
        #region Constructors
        public ElementFloat2(EventHandler handler, FieldType field, Stream s) : base(handler, field) { Parse(s); }
        public ElementFloat2(EventHandler handler) : this(handler, (FieldType)0, 0f, 0f) { }
        public ElementFloat2(EventHandler handler, ElementFloat2 basis) : this(handler, basis.field, basis.data0, basis.data1) { }
        public ElementFloat2(EventHandler handler, FieldType field, float data0, float data1) : base(handler, field) { this.data0 = data0; this.data1 = data1; }
        #endregion
    ...
    public class ElementFloat3 : ShaderData
    {
        ...
        #region Constructors
        public ElementFloat3(EventHandler handler, FieldType field, Stream s) : base(handler, field) { Parse(s); }
        public ElementFloat3(EventHandler handler) : this(handler, (FieldType)0, 0f, 0f, 0f) { }
        public ElementFloat3(EventHandler handler, ElementFloat3 basis) : this(handler, basis.field, basis.data0, basis.data1, basis.data2) { }
        public ElementFloat3(EventHandler handler, FieldType field, float data0, float data1, float data2) : base(handler, field) { this.data0 = data0; this.data1 = data1; this.data2 = data2; }
        #endregion
    ...
    public class ElementFloat4 : ShaderData
    {
        ...
        #region Constructors
        public ElementFloat4(EventHandler handler, FieldType field, Stream s) : base(handler, field) { Parse(s); }
        public ElementFloat4(EventHandler handler) : this(handler, (FieldType)0, 0f, 0f, 0f, 0f) { }
        public ElementFloat4(EventHandler handler, ElementFloat4 basis) : this(handler, basis.field, basis.data0, basis.data1, basis.data2, basis.data3) { }
        public ElementFloat4(EventHandler handler, FieldType field, float data0, float data1, float data2, float data3) : base(handler, field) { this.data0 = data0; this.data1 = data1; this.data2 = data2; this.data3 = data3; }
        #endregion
    ...
    public class ElementInt : ShaderData
    {
        ...
        #region Constructors
        public ElementInt(EventHandler handler, FieldType field, Stream s) : base(handler, field) { Parse(s); }
        public ElementInt(EventHandler handler) : this(handler, (FieldType)0, (int)0) { }
        public ElementInt(EventHandler handler, ElementInt basis) : this(handler, basis.field, basis.data) { }
        public ElementInt(EventHandler handler, FieldType field, int data) : base(handler, field) { this.data = data; }
        #endregion
    ...
    public class ElementTextureRef : ShaderData
    {
            ...
            set
            {
                if (_RCOLTag != value)
                {
                    ...
                    if (value == "GEOM")
                        ...
                        data = new GenericRCOLResource.GenericRCOLResource.ChunkReference(handler, (uint)index);
                }
            }
        }
        ...
        #region Attributes
        int index; //GEOM
        GenericRCOLResource.GenericRCOLResource.ChunkReference data; //!GEOM
        #endregion

        #region Constructors
        private ElementTextureRef(EventHandler handler, FieldType field, DependentList<TGIBlock> ParentTGIBlocks = null,
            string RCOLTag = "MATD")
            : base(handler, field) { _ParentTGIBlocks = ParentTGIBlocks; _RCOLTag = RCOLTag; }

        public ElementTextureRef(EventHandler handler, DependentList<TGIBlock> ParentTGIBlocks = null,
            string RCOLTag = "MATD")
            : this(handler, (FieldType)0, ParentTGIBlocks, RCOLTag) { if (_RCOLTag == "GEOM") index = 0; else data = new GenericRCOLResource.GenericRCOLResource.ChunkReference(handler); }

        public ElementTextureRef(EventHandler handler, FieldType field, Stream s,
            DependentList<TGIBlock> ParentTGIBlocks = null, string RCOLTag = "MATD")
            : this(handler, field, ParentTGIBlocks, RCOLTag) { Parse(s); }
        ...
        public ElementTextureRef(EventHandler handler, ElementTextureRef basis,
            ...
            : this(handler, basis.field, ParentTGIBlocks ?? basis._ParentTGIBlocks, RCOLTag ?? basis._RCOLTag) { if (_RCOLTag == "GEOM") index = basis.index; else data = new GenericRCOLResource.GenericRCOLResource.ChunkReference(handler, basis.data); }

        public ElementTextureRef(EventHandler handler, FieldType field, int index,
            DependentList<TGIBlock> ParentTGIBlocks)
            : this(handler, field, ParentTGIBlocks, "GEOM") { this.index = index; }
        public ElementTextureRef(EventHandler handler, FieldType field, GenericRCOLResource.GenericRCOLResource.ChunkReference data)
            : this(handler, field, null, "MATD") { this.data = new GenericRCOLResource.GenericRCOLResource.ChunkReference(handler, data); }
        #endregion
        ...
        #region Content Fields
        [ElementPriority(11)]
        public GenericRCOLResource.GenericRCOLResource.ChunkReference Data
        {
            get { if (_RCOLTag == "GEOM") throw new InvalidOperationException("Use Index not Data for GEOM"); return data; }
            set { if (_RCOLTag == "GEOM") throw new InvalidOperationException("Use Index not Data for GEOM"); if (data != value) { data = new GenericRCOLResource.GenericRCOLResource.ChunkReference(handler, value); OnElementChanged(); } }
        }
    ...
    public class ElementTextureKey : ShaderData
    {
        ...
        #region Constructors
        public ElementTextureKey(EventHandler handler, FieldType field, Stream s) : base(handler, field) { Parse(s); }
        public ElementTextureKey(EventHandler handler) : this(handler, (FieldType)0, (uint)0, (uint)0, (ulong)0) { }
        public ElementTextureKey(EventHandler handler, ElementTextureKey basis) : this(handler, basis.field, basis.data) { }
        public ElementTextureKey(EventHandler handler, FieldType field, IResourceKey data) : base(handler, field) { this.data = new TGIBlock(handler, "ITG", data); }
        public ElementTextureKey(EventHandler handler, FieldType field, uint resourceType, uint resourceGroup,
            ulong instance) : base(handler, field) { this.data = new TGIBlock(handler, "ITG", resourceType, resourceGroup, instance); }
        #endregion

        #region Data I/O
        void Parse(Stream s) { data = new TGIBlock(handler, "ITG", s); ReadZeros(s, 4); }

        protected override void UnParse(Stream s) { if (data == null) data = new TGIBlock(handler, "ITG"); data.UnParse(s); WriteZeros(s, 4); }
        protected override DataType DataTypeFromType { get { return DataType.dtTexture; } }
        ...
        #region Content Fields
        [ElementPriority(11)]
        public IResourceKey Data { get { return data; } set { if (!data.Equals(value)) { data = new TGIBlock(handler, "ITG", value); OnElementChanged(); } } }
        #endregion
    }
    ...
    public class ShaderDataList : DependentList<ShaderData>
    {
        ...
        public DependentList<TGIBlock> ParentTGIBlocks
        {
            ...
            set { if (_ParentTGIBlocks != value) { _ParentTGIBlocks = value; foreach (ShaderData i in this) if (i is ElementTextureRef) i.ParentTGIBlocks = _ParentTGIBlocks; } }
        }
        ...
        {
            get { return _RCOLTag; }
            set { if (_RCOLTag != value) { _RCOLTag = value; foreach (ShaderData i in this) if (i is ElementTextureRef) i.RCOLTag = _RCOLTag; } }
        }
            ...
            : base(handler)
        {
            ...
            this._ParentTGIBlocks = ParentTGIBlocks;
            this._RCOLTag = RCOLTag;
            foreach (ShaderData t in ilt) this.Add(t);
            this.handler = handler;
        }
        #endregion
        ...
        internal void Parse(Stream s, long start, Nullable<int> expectedDataLen)
        {
            ...
            {
                ShaderData entry = ShaderData.CreateEntry(elementHandler, s, start, _ParentTGIBlocks, _RCOLTag);
                this.Add(entry);
                dataLen += this[Count - 1].ByteCount() * 4;
            }
            if (expectedDataLen != null && expectedDataLen != dataLen)
        ...
        {
            WriteCount(s, Count);
            foreach (ShaderData element in this) element.UnParseHeader(s);
            dataPos = s.Position;
            foreach (ShaderData element in this) element.UnParseData(s, start);
        }
        ...
        {
            if (item is ElementTextureRef) { ElementTextureRef element = item as ElementTextureRef; element.ParentTGIBlocks = _ParentTGIBlocks; element.RCOLTag = _RCOLTag; }
            base.Add(item);
        }
        public override void Add(Type elementType)
        {
            ...
            if (typeof(ElementTextureRef).IsAssignableFrom(elementType))
                newElement = Activator.CreateInstance(elementType, new object[] { elementHandler, _ParentTGIBlocks, _RCOLTag, }) as ElementTextureRef;
            else
                newElement = Activator.CreateInstance(elementType, new object[] { elementHandler, }) as ShaderData;
            base.Add(newElement);
        }
    }
}