...
namespace Regul.S3PI.Resources.RCOLChunks
{
    public class SlotAdjust : ARCOLBlock
    {
        ...
        #region Constructors
        public SlotAdjust(EventHandler handler) : base(handler, null) { }
        public SlotAdjust(EventHandler handler, Stream s) : base(handler, s) { }
        public SlotAdjust(EventHandler handler, SlotAdjust basis)
            : this(handler, basis.version, basis.adjustments) { }
        public SlotAdjust(EventHandler handler, uint version, IEnumerable<Adjustment> adjustments)
            : base(handler, null)
        {
        ...
        public class Adjustment : AHandlerElement, IEquatable<Adjustment>
        {
            ...
            #region Constructors
            public Adjustment(EventHandler handler) : base(handler) { }
            public Adjustment(EventHandler handler, Stream s) : base(handler) { Parse(s); }
            public Adjustment(EventHandler handler, Adjustment basis)
                : this(handler,
            ...
            public Adjustment(EventHandler handler,
                uint slotName, float offsetX, float offsetY, float offsetZ, float scaleX, float scaleY, float scaleZ,
        ...
        public class AdjustmentList : DependentList<Adjustment>
        {
            ...
            protected override Adjustment CreateElement(Stream s) { return new Adjustment(elementHandler, s); }
