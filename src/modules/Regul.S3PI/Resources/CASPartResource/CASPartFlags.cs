...
namespace Regul.S3PI.Resources.CASPartResource
{
    ...
    public class AgeGenderFlags : AHandlerElement, IEquatable<AgeGenderFlags>
    {
        ...
        #region Constructors
        public AgeGenderFlags(EventHandler handler) : base(handler) { }
        public AgeGenderFlags(EventHandler handler, Stream s) : base(handler) { Parse(s); }
        public AgeGenderFlags(EventHandler handler, AgeGenderFlags basis) : base(handler) { this.dword = basis.dword; }
        public AgeGenderFlags(EventHandler handler, AgeFlags age, GenderFlags gender, SpeciesType species,
