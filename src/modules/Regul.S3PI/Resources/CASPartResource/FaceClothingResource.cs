...
namespace Regul.S3PI.Resources.CASPartResource
{
    ...
    public class FaceClothingResource : AResource
    {
        ...
        public FaceClothingResource(Stream s) : base(s) { if (stream == null) { stream = UnParse(); OnResourceChanged(this, EventArgs.Empty); } stream.Position = 0; Parse(stream); }
        ...
        void Parse(Stream s)
        {
            ...
            if (version >= 8)
            {
                blendGeometry = new TGIBlock(OnResourceChanged, s);
            }
        ...
        protected override Stream UnParse()
        {
            ...
            if (version >= 8)
            {
                if (blendGeometry == null) blendGeometry = new TGIBlock(OnResourceChanged);
        ...
        public class Entry : AHandlerElement, IEquatable<Entry>
        {
            ...
            #region Constructors
            public Entry(EventHandler handler, DependentList<TGIBlock> ParentTGIBlocks = null)
                : base(handler)
            {
                this.ParentTGIBlocks = ParentTGIBlocks;
                ageGender = new AgeGenderFlags(handler);
            }
            public Entry(EventHandler handler, Stream s, DependentList<TGIBlock> ParentTGIBlocks = null)
                : base(handler)
            {
                this.ParentTGIBlocks = ParentTGIBlocks;
                Parse(s);
            }
            public Entry(EventHandler handler, Entry basis, DependentList<TGIBlock> ParentTGIBlocks = null)
                : this(handler, basis.ageGender, basis.amount, basis.index, ParentTGIBlocks ?? basis.ParentTGIBlocks) { }
        ...
        public class EntryList : DependentList<Entry>
        {
            ...
            public DependentList<TGIBlock> ParentTGIBlocks
            {
                ...
                set { if (_ParentTGIBlocks != value) { _ParentTGIBlocks = value; foreach (Entry i in this) i.ParentTGIBlocks = _ParentTGIBlocks; } }
            }
            ...
            public EntryList(EventHandler handler, IEnumerable<Entry> le, DependentList<TGIBlock> ParentTGIBlocks = null)
                : this(null, ParentTGIBlocks) { elementHandler = handler; foreach (Entry t in le) this.Add((Entry)t.Clone(null)); this.handler = handler; }
            #endregion

            #region Data I/O
            protected override Entry CreateElement(Stream s) { return new Entry(elementHandler, s) { ParentTGIBlocks = ParentTGIBlocks }; }
            protected override void WriteElement(Stream s, Entry element) { element.UnParse(s); }
            #endregion

            public override void Add() { this.Add(new Entry(handler, _ParentTGIBlocks)); }
        ...
        public class CASEntry : AHandlerElement, IEquatable<CASEntry>
        {
            ...
            #region Constructors
            public CASEntry(EventHandler handler, DependentList<TGIBlock> ParentTGIBlocks = null)
                : base(handler)
            {
                geomEntries = new EntryList(handler, _ParentTGIBlocks);
                geomEntries = new EntryList(handler, _ParentTGIBlocks);
            }
            public CASEntry(EventHandler handler, Stream s, DependentList<TGIBlock> ParentTGIBlocks = null)
                : base(handler)
            {
                this._ParentTGIBlocks = ParentTGIBlocks;
                Parse(s);
            }
            public CASEntry(EventHandler handler, CASEntry basis, DependentList<TGIBlock> ParentTGIBlocks = null)
                : this(handler, basis.facialRegion, basis.geomEntries, basis.boneEntries,
                ParentTGIBlocks ?? basis._ParentTGIBlocks) { }
            public CASEntry(EventHandler handler, FacialRegionFlags facialRegion, EntryList geomEntries,
                EntryList boneEntries,
                DependentList<TGIBlock> ParentTGIBlocks = null)
                : base(handler)
            {
        ...
        public class CASEntryList : DependentList<CASEntry>
        {
            ...
            public CASEntryList(EventHandler handler, IEnumerable<CASEntry> le, DependentList<TGIBlock> ParentTGIBlocks = null)
                : this(null, ParentTGIBlocks) { elementHandler = handler; foreach (CASEntry t in le) this.Add((CASEntry)t.Clone(null)); this.handler = handler; }
            #endregion

            #region Data I/O
            protected override CASEntry CreateElement(Stream s) { return new CASEntry(elementHandler, s) { ParentTGIBlocks = ParentTGIBlocks }; }
            protected override void WriteElement(Stream s, CASEntry element) { element.UnParse(s); }
            #endregion

            public override void Add() { this.Add(new CASEntry(handler, _ParentTGIBlocks)); }
        ...
        public TGIBlock BlendGeometry
        {
            ...
            set { if (version < 8) throw new InvalidOperationException(); if (!blendGeometry.Equals(value)) { blendGeometry = new TGIBlock(OnResourceChanged, value); OnResourceChanged(this, EventArgs.Empty); } }
        }
        [ElementPriority(5)]
