...
namespace Regul.S3PI.Resources.CASPartResource
{
    /// <summary>
    ...
    public class SimOutfitResource : AResource
    {
        ...
        public SimOutfitResource(Stream s) : base(s) { if (stream == null) { stream = UnParse(); OnResourceChanged(this, EventArgs.Empty); } stream.Position = 0; Parse(stream); }
        ...
        void Parse(Stream s)
        {
            ...
            if (version >= 0x08)
            {
                ...
                age = new AgeGenderFlags(OnResourceChanged, s);
                gender = new AgeGenderFlags(OnResourceChanged, s);
                species = new AgeGenderFlags(OnResourceChanged, s);

                if (version >= 0x09)
                    handedness = new AgeGenderFlags(OnResourceChanged, s);
                ...
                if (version >= 0x09)
                {
                    if (version >= 0x000E)
                    {
                        ...
                        if (version >= 0x0013)
                        {
                            ...
                            if (version >= 0x0014)
                            {
                                furMap = new TGIBlock(OnResourceChanged, s);
                            }
                        }
                    }
                    else
            ...
            else
            {
                ...
                agev7 = new AgeGenderFlags(OnResourceChanged, s);
                genderv7 = new AgeGenderFlags(OnResourceChanged, s);

                unknown4v7 = r.ReadUInt32();

                skinTonev7 = new TGIBlock(OnResourceChanged, "IGT", s);
                hairTonev7 = new TGIBlock(OnResourceChanged, "IGT", s);
                ...
                if (version >= 0x09)
                {
                    if (version >= 0x000E)
                    {
                        ...
                        if (version >= 0x0013)
                        {
                            ...
                            if (version >= 0x0014)
                            {
                                if (furMap == null) furMap = new TGIBlock(OnResourceChanged);
                                furMap.UnParse(s);
                            }
                        }
                    }
        ...
        public class XMLEntry : AHandlerElement, IEquatable<XMLEntry>
        {
            ...
            #region Constructors
            public XMLEntry(EventHandler handler, uint parentVersion) : base(handler)
            {
                if (parentVersion < 0x0B)
            ...
            public XMLEntry(EventHandler handler, Stream s, uint parentVersion) : this(handler, parentVersion) { Parse(s); }
            public XMLEntry(EventHandler handler, XMLEntry basis, uint parentVersion) : this(handler, basis.unknown1, basis.xml, parentVersion) { }
            public XMLEntry(EventHandler handler, byte unknown1, string xml, uint parentVersion)
                : this(handler, parentVersion) { this.unknown1 = unknown1; this.xml = xml; }
            #endregion
            ...
            protected override List<string> ValueBuilderFields
            {
                get
                {
                    List<string> res = base.ValueBuilderFields;
                    res.Remove("XmlFile");
                    return res;
                }
            }
        ...
        public class XMLEntryList : DependentList<XMLEntry>
        {
            ...
            public uint ParentVersion
            {
                ...
                set { if (_ParentVersion != value) { _ParentVersion = value; foreach (XMLEntry i in this) i.ParentVersion = _ParentVersion; } }
            }
            ...
            public XMLEntryList(EventHandler handler, IEnumerable<XMLEntry> le, uint parentVersion) : this(null, parentVersion) { elementHandler = handler; foreach (XMLEntry x in le) this.Add((XMLEntry)x.Clone(null)); this.handler = handler; }
            #endregion

            #region Data I/O
            protected override XMLEntry CreateElement(Stream s) { return new XMLEntry(elementHandler, s, _ParentVersion); }
            protected override void WriteElement(Stream s, XMLEntry element) { element.UnParse(s); }
            #endregion

            public override void Add() { base.Add(new XMLEntry(handler, _ParentVersion)); }
        ...
        public class IndexPair : AHandlerElement, IEquatable<IndexPair>
        {
            ...
            public uint ParentVersion
            {
                ...
                set
                {
                    if (_ParentVersion >= 0x15 && value < 0x15 && (!txtc1index.IsByteSized() || !txtc2index.IsByteSized()))
            ...
            #region Constructors
            public IndexPair(EventHandler handler, uint parentVersion, DependentList<TGIBlock> ParentTGIBlocks = null) : base(handler)
            {
                this._ParentVersion = parentVersion;
                this.ParentTGIBlocks = ParentTGIBlocks;
            }
            public IndexPair(EventHandler handler, Stream s, uint parentVersion,
            ...
            public IndexPair(EventHandler handler, IndexPair basis, uint parentVersion,
                DependentList<TGIBlock> ParentTGIBlocks = null)
                : this(handler, basis.txtc1index, basis.txtc2index, parentVersion, ParentTGIBlocks ?? basis.ParentTGIBlocks) { }
            public IndexPair(EventHandler handler, byte txtc1index, byte txtc2index, uint parentVersion,
                DependentList<TGIBlock> ParentTGIBlocks = null)
                : this(handler, (short)txtc1index, (short)txtc2index, parentVersion, ParentTGIBlocks)
            {
                if (parentVersion >= 0x15)
            ...
            public IndexPair(EventHandler handler, short txtc1index, short txtc2index, uint parentVersion,
                DependentList<TGIBlock> ParentTGIBlocks = null)
                : base(handler)
            {
                if (parentVersion < 0x15 && (!txtc1index.IsByteSized() || !txtc2index.IsByteSized()))
                    throw new InvalidOperationException();
        ...
        public class IndexPairList : DependentList<IndexPair>
        {
            ...
            public DependentList<TGIBlock> ParentTGIBlocks
            {
                ...
                set { if (_ParentTGIBlocks != value) { _ParentTGIBlocks = value; foreach (IndexPair i in this) i.ParentTGIBlocks = _ParentTGIBlocks; } }
            }
            ...
            {
                get { return _ParentVersion; }
                set { if (_ParentVersion != value) { _ParentVersion = value; foreach (IndexPair item in this) item.ParentVersion = _ParentVersion; } }
            }
            ...
            public IndexPairList(EventHandler handler, IEnumerable<IndexPair> le, uint parentVersion, DependentList<TGIBlock> ParentTGIBlocks = null)
                : this(null, parentVersion, ParentTGIBlocks) { elementHandler = handler; foreach (IndexPair t in le) this.Add((IndexPair)t.Clone(null)); this.handler = handler; }
            #endregion
            ...
            protected override IndexPair CreateElement(Stream s) { return new IndexPair(elementHandler, s, _ParentVersion, _ParentTGIBlocks); }
            protected override void WriteElement(Stream s, IndexPair element) { element.UnParse(s); }
            #endregion

            public override void Add() { base.Add(new IndexPair(handler, _ParentVersion, _ParentTGIBlocks)); }
        ...
        public class CASEntry : AHandlerElement, IEquatable<CASEntry>
        {
            ...
            public uint ParentVersion
            {
                ...
                set
                {
                    ...
                    {
                        if (_ParentVersion >= 0x15 && value < 0x15 && !casPartIndex.IsByteSized())
                            throw new InvalidOperationException();
                        _ParentVersion = value;
            ...
            #region Constructors
            public CASEntry(EventHandler handler, uint ParentVersion, DependentList<TGIBlock> ParentTGIBlocks = null)
                : base(handler)
            {
            ...
            public CASEntry(EventHandler handler, Stream s, uint ParentVersion,
                DependentList<TGIBlock> ParentTGIBlocks = null)
                : base(handler) { _ParentVersion = ParentVersion; _ParentTGIBlocks = ParentTGIBlocks; Parse(s); }
            public CASEntry(EventHandler handler, CASEntry basis, uint ParentVersion,
                DependentList<TGIBlock> ParentTGIBlocks = null)
                : this(handler, basis.casPartIndex, basis.clothing, basis.txtcIndexes, ParentVersion, ParentTGIBlocks ?? basis.ParentTGIBlocks) { }
            public CASEntry(EventHandler handler, byte casPartIndex, IEnumerable<IndexPair> ibe, uint ParentVersion,
                DependentList<TGIBlock> ParentTGIBlocks = null)
                : this(handler, casPartIndex, 0, ibe, ParentVersion, ParentTGIBlocks)
            {
                if (ParentVersion >= 0x0E)
                    throw new InvalidOperationException(String.Format("ClothingType must be specified for version {0}", ParentVersion));
            }
            public CASEntry(EventHandler handler, byte casPartIndex, ClothingType clothing, IEnumerable<IndexPair> ibe,
                uint ParentVersion, DependentList<TGIBlock> ParentTGIBlocks = null)
                : this(handler, (short)casPartIndex, clothing, ibe, ParentVersion, ParentTGIBlocks)
            {
                if (ParentVersion >= 0x15)
                    throw new InvalidOperationException(String.Format("CasPartIndex must be short for version {0}", ParentVersion));
            }
            public CASEntry(EventHandler handler, short casPartIndex, ClothingType clothing, IEnumerable<IndexPair> ibe,
                uint ParentVersion, DependentList<TGIBlock> ParentTGIBlocks = null)
                : base(handler)
            {
                if (ParentVersion < 0x15 && !casPartIndex.IsByteSized())
                    throw new InvalidOperationException();
        ...
        public class CASEntryList : DependentList<CASEntry>
        {
            ...
            {
                get { return _ParentTGIBlocks; }
                set { if (_ParentTGIBlocks != value) { _ParentTGIBlocks = value; foreach (CASEntry i in this) i.ParentTGIBlocks = _ParentTGIBlocks; } }
            }
            ...
            {
                get { return _ParentVersion; }
                set { if (_ParentVersion != value) { _ParentVersion = value; foreach (CASEntry item in this) item.ParentVersion = _ParentVersion; } }
            }
            ...
            public CASEntryList(EventHandler handler, IEnumerable<CASEntry> le, uint parentVersion, DependentList<TGIBlock> ParentTGIBlocks = null)
                : base(handler, Byte.MaxValue) { _ParentVersion = parentVersion; _ParentTGIBlocks = ParentTGIBlocks; elementHandler = handler; foreach (CASEntry t in le) this.Add(t); this.handler = handler; }
            #endregion

            #region Data I/O
            protected override int ReadCount(Stream s) { return new BinaryReader(s).ReadByte(); }
            protected override void WriteCount(Stream s, int count) { new BinaryWriter(s).Write((byte)count); }
            protected override CASEntry CreateElement(Stream s) { return new CASEntry(elementHandler, s, _ParentVersion, _ParentTGIBlocks); }
            protected override void WriteElement(Stream s, CASEntry element) { element.UnParse(s); }
            #endregion

            public override void Add() { base.Add(new CASEntry(handler, _ParentVersion, _ParentTGIBlocks)); }
        ...
        public class TGIPair : AHandlerElement, IEquatable<TGIPair>
        {
            ...
            #region Constructors
            public TGIPair(EventHandler handler, uint parentVersion)
                : base(handler)
            {
                this.ParentVersion = parentVersion;
            }
            public TGIPair(EventHandler handler, Stream s, uint parentVersion)
                : base(handler)
            {
                this.ParentVersion = parentVersion;
                Parse(s);
            }
            public TGIPair(EventHandler handler, TGIPair basis, uint parentVersion)
                : this(handler, basis.txtc1TGI, basis.txtc2TGI, parentVersion) { }
            public TGIPair(EventHandler handler, IResourceKey txtc1TGI, IResourceKey txtc2TGI, uint parentVersion)
                : base(handler)
            {
                if (parentVersion >= 0x08)
                    throw new InvalidOperationException();

                this.ParentVersion = parentVersion;
                this.txtc1TGI = new TGIBlock(handler, txtc1TGI);
                this.txtc2TGI = new TGIBlock(handler, txtc2TGI);
            }
            #endregion
            ...
            void Parse(Stream s)
            {
                txtc1TGI = new TGIBlock(handler, s);
                txtc2TGI = new TGIBlock(handler, s);
            }
            ...
            #region Content Fields
            [ElementPriority(1)]
            public IResourceKey TXTC1TGI { get { return txtc1TGI; } set { if (!txtc1TGI.Equals(value)) { txtc1TGI = new TGIBlock(handler, value); OnElementChanged(); } } }
            [ElementPriority(1)]
            public IResourceKey TXTC2TGI { get { return txtc2TGI; } set { if (!txtc2TGI.Equals(value)) { txtc2TGI = new TGIBlock(handler, value); OnElementChanged(); } } }
        ...
        public class TGIPairList : DependentList<TGIPair>
        {
            ...
            {
                get { return _ParentVersion; }
                set { if (_ParentVersion != value) { _ParentVersion = value; foreach (TGIPair item in this) item.ParentVersion = _ParentVersion; } }
            }
            ...
            public TGIPairList(EventHandler handler, IEnumerable<TGIPair> le, uint parentVersion)
                : this(null, parentVersion) { elementHandler = handler; foreach (TGIPair t in le) this.Add((TGIPair)t.Clone(null)); this.handler = handler; }
            #endregion

            #region Data I/O
            protected override int ReadCount(Stream s) { return new BinaryReader(s).ReadByte(); }
            protected override void WriteCount(Stream s, int count) { new BinaryWriter(s).Write((Byte)count); }
            protected override TGIPair CreateElement(Stream s) { return new TGIPair(elementHandler, s, _ParentVersion); }
            protected override void WriteElement(Stream s, TGIPair element) { element.UnParse(s); }
            #endregion

            public override void Add() { base.Add(new TGIPair(handler, _ParentVersion)); }
        ...
        public class CASV7Entry : AHandlerElement, IEquatable<CASV7Entry>
        {
            ...
            #region Constructors
            public CASV7Entry(EventHandler handler, uint ParentVersion)
                : base(handler)
            {
                _ParentVersion = ParentVersion;
                casPart = null;
            ...
            public CASV7Entry(EventHandler handler, Stream s, uint ParentVersion)
                : base(handler) { _ParentVersion = ParentVersion; Parse(s); }
            public CASV7Entry(EventHandler handler, CASV7Entry basis, uint ParentVersion)
                : this(handler, basis.casPart, basis.txtcTGIs, basis.clothing, ParentVersion) { }
            public CASV7Entry(EventHandler handler, IResourceKey casPart, IEnumerable<TGIPair> ibe,
                ClothingType clothing, uint ParentVersion)
                : base(handler)
            {
                _ParentVersion = ParentVersion;
                this.casPart = new TGIBlock(handler, casPart);
            ...
            void Parse(Stream s)
            {
                casPart = new TGIBlock(handler, s);
            ...
            internal void UnParse(Stream s)
            {
                if (casPart == null) casPart = new TGIBlock(handler);
                casPart.UnParse(s);
            ...
            #region Content Fields
            [ElementPriority(1)]
            public IResourceKey CASPart { get { return casPart; } set { if (!casPart.Equals(value)) { casPart = value == null ? null : new TGIBlock(handler, value); OnElementChanged(); } } }
            [ElementPriority(2)]
        ...
        public class CASV7EntryList : DependentList<CASV7Entry>
        {
            ...
            {
                get { return _ParentVersion; }
                set { if (_ParentVersion != value) { _ParentVersion = value; foreach (CASV7Entry item in this) item.ParentVersion = _ParentVersion; } }
            }
            ...
            public CASV7EntryList(EventHandler handler, IEnumerable<CASV7Entry> le, uint parentVersion)
                : base(handler, Byte.MaxValue) { _ParentVersion = parentVersion; elementHandler = handler; foreach (CASV7Entry t in le) this.Add(t); this.handler = handler; }
            #endregion

            #region Data I/O
            protected override int ReadCount(Stream s) { return new BinaryReader(s).ReadByte(); }
            protected override void WriteCount(Stream s, int count) { new BinaryWriter(s).Write((byte)count); }
            protected override CASV7Entry CreateElement(Stream s) { return new CASV7Entry(elementHandler, s, _ParentVersion); }
            protected override void WriteElement(Stream s, CASV7Entry element) { element.UnParse(s); }
            #endregion

            public override void Add() { base.Add(new CASV7Entry(handler, _ParentVersion)); }
        ...
        public class FaceEntry : AHandlerElement, IEquatable<FaceEntry>
        {
            ...
            public uint ParentVersion
            {
                ...
                set
                {
                    if (_ParentVersion >= 0x15 && value < 0x15 && !faceIndex.IsByteSized())
                        throw new InvalidOperationException();
                    _ParentVersion = value;
                }
            }
            ...
            #region Constructors
            public FaceEntry(EventHandler handler, uint parentVersion, DependentList<TGIBlock> ParentTGIBlocks = null) : base(handler)
            {
                _ParentVersion = parentVersion;
                this.ParentTGIBlocks = ParentTGIBlocks;
            }
            public FaceEntry(EventHandler handler, Stream s, uint parentVersion,
                DependentList<TGIBlock> ParentTGIBlocks = null)
                : this(handler, parentVersion, ParentTGIBlocks) { Parse(s); }
            public FaceEntry(EventHandler handler, FaceEntry basis, uint parentVersion,
                DependentList<TGIBlock> ParentTGIBlocks = null)
                : this(handler, basis.faceIndex, basis.unknown1, parentVersion, ParentTGIBlocks) { }
            public FaceEntry(EventHandler handler, byte faceIndex, float unknown1, uint parentVersion,
                DependentList<TGIBlock> ParentTGIBlocks = null)
                : this(handler, (short)faceIndex, unknown1, parentVersion, ParentTGIBlocks)
            {
                if (ParentVersion >= 0x15)
                    throw new InvalidOperationException(String.Format("FaceIndex must be short for version {0}", ParentVersion));
            }
            public FaceEntry(EventHandler handler, short faceIndex, float unknown1, uint parentVersion,
                DependentList<TGIBlock> ParentTGIBlocks = null)
                : this(handler, parentVersion, ParentTGIBlocks)
            {
                if (parentVersion < 0x15 && faceIndex.IsByteSized())
                    throw new InvalidOperationException();
        ...
        public class FaceEntryList : DependentList<FaceEntry>
        {
            ...
            {
                get { return _ParentTGIBlocks; }
                set { if (_ParentTGIBlocks != value) { _ParentTGIBlocks = value; foreach (FaceEntry i in this) i.ParentTGIBlocks = _ParentTGIBlocks; } }
            }
            ...
            {
                get { return _ParentVersion; }
                set { if (_ParentVersion != value) { _ParentVersion = value; foreach (FaceEntry item in this) item.ParentVersion = _ParentVersion; } }
            }
            ...
            public FaceEntryList(EventHandler handler, IEnumerable<FaceEntry> le, uint parentVersion, DependentList<TGIBlock> ParentTGIBlocks = null)
                : this(null, parentVersion, ParentTGIBlocks) { elementHandler = handler; foreach (FaceEntry t in le) this.Add((FaceEntry)t.Clone(null)); this.handler = handler; }
            #endregion

            #region Data I/O
            protected override int ReadCount(Stream s) { return new BinaryReader(s).ReadByte(); }
            protected override void WriteCount(Stream s, int count) { new BinaryWriter(s).Write((Byte)count); }
            protected override FaceEntry CreateElement(Stream s) { return new FaceEntry(elementHandler, s, _ParentVersion, _ParentTGIBlocks); }
            protected override void WriteElement(Stream s, FaceEntry element) { element.UnParse(s); }
            #endregion

            public override void Add() { base.Add(new FaceEntry(handler, _ParentVersion, _ParentTGIBlocks)); }
        ...
        public IResourceKey FurMap
        {
            ...
            set { if (version < 0x00000014) throw new InvalidOperationException(); if (!furMap.Equals(value)) { furMap = new TGIBlock(OnResourceChanged, value); OnResourceChanged(this, EventArgs.Empty); } }
        }
        [ElementPriority(24)]
        ...
        public IResourceKey SkinToneV7
        {
            ...
            set { if (version >= 0x00000008) throw new InvalidOperationException(); if (!skinTonev7.Equals(value)) { skinTonev7 = new TGIBlock(OnResourceChanged, value); OnResourceChanged(this, EventArgs.Empty); } }
        }
        [ElementPriority(9)]
        public IResourceKey HairToneV7
        {
            get { if (version >= 0x00000008) throw new InvalidOperationException(); return hairTonev7; }
            set { if (version >= 0x00000008) throw new InvalidOperationException(); if (!hairTonev7.Equals(value)) { hairTonev7 = new TGIBlock(OnResourceChanged, value); OnResourceChanged(this, EventArgs.Empty); } }
        }
        [ElementPriority(10)]
