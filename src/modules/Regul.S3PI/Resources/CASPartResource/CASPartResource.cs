...
namespace Regul.S3PI.Resources.CASPartResource
{
    ...
    public class CASPartResource : AResource
    {
        ...
        public CASPartResource(Stream s) : base(s) { if (stream == null) { stream = UnParse(); OnResourceChanged(this, EventArgs.Empty); } stream.Position = 0; Parse(stream); }
        ...
        void Parse(Stream s)
        {
            ...
            ageGender = new AgeGenderFlags(OnResourceChanged, s);
        ...
        protected override Stream UnParse()
        {
            ...
            if (ageGender == null) ageGender = new AgeGenderFlags(OnResourceChanged);
            ageGender.UnParse(s);
        ...
        public class Preset : AHandlerElement, IEquatable<Preset>
        {
            ...
            #region Constructors
            public Preset(EventHandler handler) : base(handler) { }
            public Preset(EventHandler handler, Stream s) : base(handler) { Parse(s); }
            public Preset(EventHandler handler, Preset basis) : this(handler, basis.xml, basis.unknown1) { }
            public Preset(EventHandler handler, string xml, uint unknown1) : base(handler) { this.xml = xml; this.unknown1 = unknown1; }
            #endregion
        ...
        public class PresetList : DependentList<Preset>
        {
            ...
            #region Data I/O
            protected override Preset CreateElement(Stream s) { return new Preset(elementHandler, s); }
        ...
        public class LODInfoEntry : AHandlerElement, IEquatable<LODInfoEntry>
        {
            ...
            #region Constructors
            public LODInfoEntry(EventHandler handler) : base(handler) { lodAssets = new LODAssetList(handler); }
            public LODInfoEntry(EventHandler handler, Stream s) : base(handler) { Parse(s); }
            public LODInfoEntry(EventHandler handler, LODInfoEntry basis)
                : this(handler, basis.level, basis.destTexture, basis.lodAssets) { }
            public LODInfoEntry(EventHandler handler, byte level, DataTypeFlags destTexture,
                IEnumerable<LODAsset> lodAssets)
                : base(handler)
            {
                this.level = level;
        ...
        public class LODInfoEntryList : DependentList<LODInfoEntry>
        {
            ...
            protected override LODInfoEntry CreateElement(Stream s) { return new LODInfoEntry(elementHandler, s); }
        ...
        public class LODAsset : AHandlerElement, IEquatable<LODAsset>
        {
            ...
            #region Constructors
            public LODAsset(EventHandler handler) : base(handler) { }
            public LODAsset(EventHandler handler, Stream s) : base(handler) { Parse(s); }
            public LODAsset(EventHandler handler, LODAsset basis) : this(handler, basis.sorting, basis.specLevel, basis.castShadow) { }
            public LODAsset(EventHandler handler, CASGeomFlags sorting, CASGeomFlags specLevel, CASGeomFlags castShadow)
                : base(handler) { this.sorting = sorting; this.specLevel = specLevel; this.castShadow = castShadow; }
            #endregion
        ...
        public class LODAssetList : DependentList<LODAsset>
        {
            ...
            protected override int ReadCount(Stream s) { return new BinaryReader(s).ReadByte(); }
            protected override void WriteCount(Stream s, int count) { new BinaryWriter(s).Write((byte)count); }
            protected override LODAsset CreateElement(Stream s) { return new LODAsset(elementHandler, s); }
        ...
        [ElementPriority(8)]
        public AgeGenderFlags AgeGender { get { return ageGender; } set { if (!ageGender.Equals(value)) { ageGender = new AgeGenderFlags(OnResourceChanged, value); OnResourceChanged(this, EventArgs.Empty); } } }
        [ElementPriority(9)]
