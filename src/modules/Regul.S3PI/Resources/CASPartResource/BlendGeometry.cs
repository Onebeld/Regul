...
namespace Regul.S3PI.Resources.CASPartResource
{
    public class BlendGeometryResource : AResource
    {
        ...
        public BlendGeometryResource(Stream s) : base(s) { if (stream == null) { stream = UnParse(); OnResourceChanged(this, EventArgs.Empty); } stream.Position = 0; Parse(stream); }
        ...
        public class LODSection : AHandlerElement, IEquatable<LODSection>
        {
            ...
            #region Constructors
            public LODSection(EventHandler handler) : base(handler) { }
            public LODSection(EventHandler handler, Stream s) : base(handler) { Parse(s); }
            public LODSection(EventHandler handler, LODSection basis) : this(handler, basis.lastIndex, basis.section2Index, basis.section3Index) { }
            public LODSection(EventHandler handler, int lastIndex, int section2Index, int section3Index) : base(handler) { this.lastIndex = lastIndex; this.section2Index = section2Index; this.section3Index = section3Index; }
            #endregion
        ...
        public class Section1Entry : AHandlerElement, IEquatable<Section1Entry>
        {
            ...
            public Section1Entry(EventHandler handler, Stream s) : base(handler) { Parse(s); }
            public Section1Entry(EventHandler handler, Section1Entry basis) : this(handler, basis.lod1, basis.lod2, basis.lod3, basis.lod4) { }
            ...
            void Parse(Stream s)
            {
                ageGender = new AgeGenderFlags(handler, s);
                facialRegion = (FacialRegionFlags)new BinaryReader(s).ReadUInt32();
                lod1 = new LODSection(handler, s);
                lod2 = new LODSection(handler, s);
                lod3 = new LODSection(handler, s);
                lod4 = new LODSection(handler, s);
            }

            internal void UnParse(Stream s)
            {
                if (ageGender == null) ageGender = new AgeGenderFlags(handler);
                ageGender.UnParse(s);
                new BinaryWriter(s).Write((uint)facialRegion);
                if (lod1 == null) lod1 = new LODSection(handler);
                lod1.UnParse(s);
                if (lod2 == null) lod2 = new LODSection(handler);
                lod2.UnParse(s);
                if (lod3 == null) lod3 = new LODSection(handler);
                lod3.UnParse(s);
                if (lod4 == null) lod4 = new LODSection(handler);
                lod4.UnParse(s);
            }
            #endregion
            ...
            #region Content Fields
            [ElementPriority(1)]
            public AgeGenderFlags AgeGender { get { return ageGender; } set { if (!ageGender.Equals(value)) { ageGender = new AgeGenderFlags(handler, value); OnElementChanged(); } } }
            [ElementPriority(2)]
            ...
            [ElementPriority(3)]
            public LODSection LOD1 { get { return lod1; } set { if (!lod1.Equals(value)) { lod1 = new LODSection(handler, value); OnElementChanged(); } } }
            [ElementPriority(4)]
            public LODSection LOD2 { get { return lod2; } set { if (!lod2.Equals(value)) { lod2 = new LODSection(handler, value); OnElementChanged(); } } }
            [ElementPriority(5)]
            public LODSection LOD3 { get { return lod3; } set { if (!lod3.Equals(value)) { lod3 = new LODSection(handler, value); OnElementChanged(); } } }
            [ElementPriority(6)]
            public LODSection LOD4 { get { return lod4; } set { if (!lod4.Equals(value)) { lod4 = new LODSection(handler, value); OnElementChanged(); } } }
        ...
        public class Section1EntryList : DependentList<Section1Entry>
        {
            ...
            protected override Section1Entry CreateElement(Stream s) { return new Section1Entry(elementHandler, s); }
        ...
        public class Section2Entry : AHandlerElement, IEquatable<Section2Entry>
        {
            ...
            #region Constructors
            public Section2Entry(EventHandler handler) : base(handler) { }
            public Section2Entry(EventHandler handler, Stream s) : base(handler) { Parse(s); }
            public Section2Entry(EventHandler handler, Section2Entry basis) : this(handler, basis.data) { }
            public Section2Entry(EventHandler handler, ushort data) : base(handler) { this.data = data; }
            #endregion
        ...
        public class Section2EntryList : DependentList<Section2Entry>
        {
            ...
            #region Data I/O
            protected override int ReadCount(Stream s) { return initialCount; }
            protected override Section2Entry CreateElement(Stream s) { return new Section2Entry(elementHandler, s); }
            protected override void WriteCount(Stream s, int count) { return; }
        ...
        public class Section3Entry : AHandlerElement, IEquatable<Section3Entry>
        {
            ...
            #region Constructors
            public Section3Entry(EventHandler handler) : base(handler) { }
            public Section3Entry(EventHandler handler, Stream s) : base(handler) { Parse(s); }
            public Section3Entry(EventHandler handler, Section3Entry basis) : this(handler, basis.data1, basis.data2, basis.data3) { }
            public Section3Entry(EventHandler handler, ushort data1, ushort data2, ushort data3) : base(handler) { this.data1 = data1; this.data2 = data2; this.data3 = data3; }
            #endregion
        ...
        public class Section3EntryList : DependentList<Section3Entry>
        {
            ...
            #region Data I/O
            protected override int ReadCount(Stream s) { return initialCount; }
            protected override Section3Entry CreateElement(Stream s) { return new Section3Entry(elementHandler, s); }
            protected override void WriteCount(Stream s, int count) { return; }
