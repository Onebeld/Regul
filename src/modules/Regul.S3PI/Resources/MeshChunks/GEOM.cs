...
using Regul.S3PI.Resources.RCOLChunks;
...
namespace Regul.S3PI.Resources.MeshChunks
{
    public class GEOM : ARCOLBlock
    {
        ...
        #region Constructors
        public GEOM(EventHandler handler) : base(handler, null) { }
        public GEOM(EventHandler handler, Stream s) : base(handler, s) { }
        public GEOM(EventHandler handler, GEOM basis)
            : this(handler,
            ...
            basis.tgiBlockList) { }
        public GEOM(EventHandler handler,
            ...
            : base(handler, null)
        {
            ...
            this.mtnf = shader == 0 ? null : new MTNF(handler, mtnf) { RCOLTag = "GEOM", };
        ...
        protected override void Parse(Stream s)
        {
            ...
            if (shader != 0)
            {
                ...
                mtnf = new MTNF(handler, s, "GEOM");
                if (s.Position != posn + size)
        ...
        public override Stream UnParse()
        {
            ...
            if (shader != 0)
            {
                if (mtnf == null) mtnf = new MTNF(handler, "GEOM") { };
        ...
        public class VertexFormat : AHandlerElement, IEquatable<VertexFormat>
        {
            ...
            public VertexFormat(EventHandler handler) : base(handler) { }
            public VertexFormat(EventHandler handler, Stream s) : base(handler) { Parse(s); }
            public VertexFormat(EventHandler handler, VertexFormat basis)
                : this(handler, basis.usage) { }
            public VertexFormat(EventHandler handler, UsageType usage)
                : base(handler)
            {
                this.usage = usage;
            }
            ...
            private void Parse(Stream s)
            {
                ...
                if (usage == 0 || (uint)usage >= expectedDataType.Length)
                ...
                if (dataType != expectedDataType[(uint)usage])
                ...
                if (elementSize != expectedElementSize[(uint)usage])
        ...
        public class VertexFormatList : DependentList<VertexFormat>
        {
            ...
            protected override VertexFormat CreateElement(Stream s) { return new VertexFormat(elementHandler, s); }
        ...
        {
            protected VertexElement(EventHandler handler) : base(handler) { }
            protected VertexElement(EventHandler handler, Stream s) : base(handler) { Parse(s); }
        ...
        public class PositionElement : VertexElement
        {
            ...
            public PositionElement(EventHandler handler) : base(handler) { }
            public PositionElement(EventHandler handler, Stream s) : base(handler, s) { }
            public PositionElement(EventHandler handler, PositionElement basis) : this(handler, basis.x, basis.y, basis.z) { }
            public PositionElement(EventHandler handler, float x, float y, float z) : base(handler) { this.x = x; this.y = y; this.z = z; }
        ...
        {
            public NormalElement(EventHandler handler) : base(handler) { }
            public NormalElement(EventHandler handler, Stream s) : base(handler, s) { }
            public NormalElement(EventHandler handler, NormalElement basis) : this(handler, basis.x, basis.y, basis.z) { }
            public NormalElement(EventHandler handler, float x, float y, float z) : base(handler) { this.x = x; this.y = y; this.z = z; }
        ...
        public class UVElement : VertexElement
        {
            ...
            public UVElement(EventHandler handler) : base(handler) { }
            public UVElement(EventHandler handler, Stream s) : base(handler, s) { }
            public UVElement(EventHandler handler, UVElement basis) : this(handler, basis.u, basis.v) { }
            public UVElement(EventHandler handler, float u, float v) : base(handler) { this.u = u; this.v = v;  }
        ...
        public class BoneAssignmentElement : VertexElement
        {
            ...
            public BoneAssignmentElement(EventHandler handler) : base(handler) { }
            public BoneAssignmentElement(EventHandler handler, Stream s) : base(handler, s) { }
            public BoneAssignmentElement(EventHandler handler, BoneAssignmentElement basis) : this(handler, basis.id) { }
            public BoneAssignmentElement(EventHandler handler, uint id) : base(handler) { this.id = id; }
        ...
        public class WeightsElement : VertexElement
        {
            ...
            public WeightsElement(EventHandler handler) : base(handler) { }
            public WeightsElement(EventHandler handler, Stream s) : base(handler, s) { }
            public WeightsElement(EventHandler handler, WeightsElement basis) : this(handler, basis.w1, basis.w2, basis.w3, basis.w4) { }
            public WeightsElement(EventHandler handler, float w1, float w2, float w3, float w4) : base(handler) { this.w1 = w1; this.w2 = w2; this.w3 = w3; this.w4 = w4; }
        ...
        {
            public TangentNormalElement(EventHandler handler) : base(handler) { }
            public TangentNormalElement(EventHandler handler, Stream s) : base(handler, s) { }
            public TangentNormalElement(EventHandler handler, TangentNormalElement basis) : this(handler, basis.x, basis.y, basis.z) { }
            public TangentNormalElement(EventHandler handler, float x, float y, float z) : base(handler) { this.x = x; this.y = y; this.z = z; }
        ...
        public class ColorElement : VertexElement
        {
            ...
            public ColorElement(EventHandler handler) : base(handler) { }
            public ColorElement(EventHandler handler, Stream s) : base(handler, s) { }
            public ColorElement(EventHandler handler, ColorElement basis) : this(handler, basis.argb) { }
            public ColorElement(EventHandler handler, uint argb) : base(handler) { this.argb = argb; }
        ...
        {
            public VertexIDElement(EventHandler handler) : base(handler) { }
            public VertexIDElement(EventHandler handler, Stream s) : base(handler, s) { }
            public VertexIDElement(EventHandler handler, VertexIDElement basis) : this(handler, basis.id) { }
            public VertexIDElement(EventHandler handler, uint id) : base(handler) { this.id = id; }
        ...
        public class ElementList : DependentList<VertexElement>
        {
                ...
                : base(null)
            {
                ...
                foreach (VertexFormat fmt in parentVertexFormats)
                {
                    switch (fmt.Usage)
                    {
                        case UsageType.Position: this.Add(new PositionElement(handler, s)); break;
                        case UsageType.Normal: this.Add(new NormalElement(handler, s)); break;
                        case UsageType.UV: this.Add(new UVElement(handler, s)); break;
                        case UsageType.BoneAssignment: this.Add(new BoneAssignmentElement(handler, s)); break;
                        case UsageType.Weights: this.Add(new WeightsElement(handler, s)); break;
                        case UsageType.TangentNormal: this.Add(new TangentNormalElement(handler, s)); break;
                        case UsageType.Color: this.Add(new ColorElement(handler, s)); break;
                        case UsageType.VertexID: this.Add(new VertexIDElement(handler, s)); break;
                    }
                }
                ...
                : base(null)
            {
                ...
                foreach (VertexFormat fmt in parentVertexFormats)
                {
                    switch (fmt.Usage)
                    {
                        case UsageType.Position: this.Add(ilt.FirstOrDefault(t => t is PositionElement) ?? new PositionElement(handler)); break;
                        case UsageType.Normal: this.Add(ilt.FirstOrDefault(t => t is NormalElement) ?? new NormalElement(handler)); break;
                        case UsageType.UV: this.Add(ilt.FirstOrDefault(t => t is UVElement) ?? new UVElement(handler)); break;
                        case UsageType.BoneAssignment: this.Add(ilt.FirstOrDefault(t => t is BoneAssignmentElement) ?? new BoneAssignmentElement(handler)); break;
                        case UsageType.Weights: this.Add(ilt.FirstOrDefault(t => t is WeightsElement) ?? new WeightsElement(handler)); break;
                        case UsageType.TangentNormal: this.Add(ilt.FirstOrDefault(t => t is TangentNormalElement) ?? new TangentNormalElement(handler)); break;
                        case UsageType.Color: this.Add(ilt.FirstOrDefault(t => t is ColorElement) ?? new ColorElement(handler)); break;
                        case UsageType.VertexID: this.Add(ilt.FirstOrDefault(t => t is VertexIDElement) ?? new VertexIDElement(handler)); break;
                    }
                }
                this.handler = handler;
            }
        ...
        public class VertexDataElement : AHandlerElement, IEquatable<VertexDataElement>
        {
            ...
            public override List<string> ContentFields { get { List<string> res = GetContentFields(GetType()); res.Remove("ParentVertexFormats"); return res; } }

            public VertexDataElement(EventHandler handler, DependentList<VertexFormat> parentVertexFormats) : base(handler) { this.ParentVertexFormats = parentVertexFormats; }
            public VertexDataElement(EventHandler handler, Stream s, DependentList<VertexFormat> parentVertexFormats) : base(handler) { this.ParentVertexFormats = parentVertexFormats; Parse(s); }
            public VertexDataElement(EventHandler handler, VertexDataElement basis) : this(handler, basis.elementList, basis.ParentVertexFormats) { }
            public VertexDataElement(EventHandler handler, DependentList<VertexElement> elementList,
        ...
        public class VertexDataList : DependentList<VertexDataElement>
        {
                ...
                : base(null)
            {
                this.parentVertexFormats = parentVertexFormats;
                elementHandler = handler;
                foreach (VertexDataElement t in ilt)
                    this.Add(t);
                this.handler = handler;
            }
            #endregion
            ...
            protected override VertexDataElement CreateElement(Stream s) { return new VertexDataElement(elementHandler, s, parentVertexFormats); }
            ...
            public override void Add() { this.Add(new VertexDataElement(elementHandler, parentVertexFormats)); }
        ...
        public class Face : AHandlerElement, IEquatable<Face>
        {
            ...
            public Face(EventHandler handler) : base(handler) { }
            public Face(EventHandler handler, Stream s) : base(handler) { Parse(s); }
            public Face(EventHandler handler, Face basis)
                : this(handler, basis.vertexDataIndex0, basis.vertexDataIndex1, basis.vertexDataIndex2) { }
            public Face(EventHandler handler, ushort vertexDataIndex0, ushort vertexDataIndex1, ushort vertexDataIndex2)
                : base(handler)
            {
        ...
        public class FaceList : DependentList<Face>
        {
            ...
            protected override Face CreateElement(Stream s) { return new Face(elementHandler, s); }
        ...
        public MTNF Mtnf
        {
            ...
            set
            {
                ...
                {
                    mtnf = new MTNF(OnRCOLChanged, value) { ParentTGIBlocks = tgiBlockList, RCOLTag = "GEOM", };
