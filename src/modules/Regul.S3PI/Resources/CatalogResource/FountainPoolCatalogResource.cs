...
namespace Regul.S3PI.Resources.CatalogResource
{
    public class FountainPoolCatalogResource : CatalogResourceTGIBlockList
    {
        ...
        #region Constructors
        public FountainPoolCatalogResource(Stream s) : base(s) { }
        public FountainPoolCatalogResource(Stream unused, FountainPoolCatalogResource basis)
            : this(basis.version,
            basis.common,
            basis.shape,
            basis.cwstIndex,
            ...
            basis.yScale,
            basis.list) { }
        public FountainPoolCatalogResource(uint version,
            Common common,
            ShapeType wallType,
            uint cwstIndex,
            uint cwalFloorIndex,
