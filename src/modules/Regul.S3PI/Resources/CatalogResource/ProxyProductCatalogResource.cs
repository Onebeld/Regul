...
namespace Regul.S3PI.Resources.CatalogResource
{
    public class ProxyProductCatalogResource : CatalogResource
    {
        ...
        #region Constructors
        public ProxyProductCatalogResource(Stream s) : base(s) { }
        public ProxyProductCatalogResource(Stream unused, ProxyProductCatalogResource basis)
            : this(basis.version, basis.common, basis.toolType) { }
        public ProxyProductCatalogResource(uint version, Common common, Tool toolType)
            : base(version, common)
        {
        ...
        protected override void Parse(Stream s)
        {
            ...
            if (this.GetType().Equals(typeof(ProxyProductCatalogResource)) && s.Position != s.Length)
