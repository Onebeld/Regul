...
namespace Regul.S3PI.Resources.CatalogResource
{
    public class RailingCatalogResource : CatalogResourceTGIBlockList
    {
        ...
        #region Constructors
        public RailingCatalogResource(Stream s) : base(s) { }
        public RailingCatalogResource(Stream unused, RailingCatalogResource basis)
        ...
        protected override void Parse(Stream s)
        {
            ...
            if (this.GetType().Equals(typeof(RailingCatalogResource)) && s.Position != s.Length)
