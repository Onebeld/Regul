...
namespace Regul.S3PI.Resources.CatalogResource
{
    ...
    public abstract class CatalogResource : AResource
    {
        ...
        #region Constructors
        protected CatalogResource(Stream s) : base(s) { if (stream == null) { stream = this.UnParse(); OnResourceChanged(this, EventArgs.Empty); } stream.Position = 0; this.Parse(stream); }
        protected CatalogResource(uint version, Common common) : base(null) { this.version = version; this.common = new Common(OnResourceChanged, common); }
        #endregion
        ...
        public class Common : AHandlerElement
        {
            ...
            #region Constructors
            internal Common(EventHandler handler, Stream s) : base(handler) { Parse(s); }

            public Common(EventHandler handler, Common basis)
                : this(basis.handler, basis.version, basis.nameGUID, basis.descGUID, basis.name, basis.desc, basis.price,
            ...
            public Common(EventHandler handler) : base(handler) { }

            public Common(EventHandler handler,
                uint version, ulong nameGUID, ulong descGUID, string name, string desc, float price,
                float nicenessMultiplier, float crapScore, BuildBuyProductStatus buildBuyProductStatusFlags,
                ulong pngInstance,
                byte unknown7, float environmentScore, Fire fireType, byte isStealable, byte isReposessable,
                uint uiSortPriority)
                : this(handler,
            ...
            public Common(EventHandler handler, uint version, ulong nameGUID, ulong descGUID, string name, string desc,
                float price,
                float nicenessMultiplier, float crapScore, BuildBuyProductStatus buildBuyProductStatusFlags,
                ulong pngInstance,
                byte unknown7, float environmentScore, Fire fireType, byte isStealable, byte isReposessable,
            ...
            IComparable<ComplateElement>, IEqualityComparer<ComplateElement>, IEquatable<ComplateElement>
        {
            ...
            #region Constructors
            protected ComplateElement(EventHandler handler, string variableName) : base(handler) { this.variableName = variableName; }
            protected ComplateElement(EventHandler handler, string variableName, Stream s) : this(handler, variableName) { Parse(s); }

            public static ComplateElement CreateTypeCode(EventHandler handler, string variableName, byte typeCode,
                Stream s, DependentList<TGIBlock> ParentTGIBlocks = null)
            {
                switch (typeCode)
                {
                    case 0x01: return new TC01_String(handler, variableName, s);
                    case 0x02: return new TC02_ARGB(handler, variableName, s);
                    case 0x03: return new TC03_TGIIndex(handler, variableName, s, ParentTGIBlocks);
                    case 0x04: return new TC04_Single(handler, variableName, s);
                    case 0x05: return new TC05_XY(handler, variableName, s);
                    case 0x06: return new TC06_XYZ(handler, variableName, s);
                    case 0x07: return new TC07_Boolean(handler, variableName, s);
                }
        ...
        public class TC01_String : ComplateElement
        {
            ...
            #region Constructors
            internal TC01_String(EventHandler handler, string variableName, Stream s) : base(handler, variableName, s) { }
            public TC01_String(EventHandler handler) : this(handler, 0, "StringVariable", "Value") { }
            public TC01_String(EventHandler handler, TC01_String basis) : this(handler, 0, basis.variableName, basis.stringValue) { }
            public TC01_String(EventHandler handler, byte unused, string variableName, string stringValue) : base(handler, variableName)
            {
        ...
        public class TC02_ARGB : ComplateElement
        {
            ...
            #region Constructors
            internal TC02_ARGB(EventHandler handler, string variableName, Stream s) : base(handler, variableName, s) { }
            public TC02_ARGB(EventHandler handler) : this(handler, 0, "ARGBVariable", (UInt32)0xFFAA8866) { }
            public TC02_ARGB(EventHandler handler, TC02_ARGB basis) : this(handler, 0, basis.variableName, basis.argb) { }
            public TC02_ARGB(EventHandler handler, byte unused, string variableName, uint argb) : base(handler, variableName)
            {
                this.argb = argb;
            }
            #endregion
        ...
        public class TC03_TGIIndex : ComplateElement
        {
            ...
            #region Constructors
            internal TC03_TGIIndex(EventHandler handler, string variableName, Stream s,
                DependentList<TGIBlock> ParentTGIBlocks = null)
                : base(handler, variableName, s) { this.ParentTGIBlocks = ParentTGIBlocks; }

            public TC03_TGIIndex(EventHandler handler, DependentList<TGIBlock> ParentTGIBlocks = null)
                : this(handler, 0, "TGIIndexVariable", (byte)0x00, ParentTGIBlocks) { }
            public TC03_TGIIndex(EventHandler handler, TC03_TGIIndex basis,
                DependentList<TGIBlock> ParentTGIBlocks = null)
                : this(handler, 0, basis.variableName, basis.tgiIndex, ParentTGIBlocks ?? basis.ParentTGIBlocks) { }
            public TC03_TGIIndex(EventHandler handler, byte unused, string variableName, byte tgiIndex,
                DependentList<TGIBlock> ParentTGIBlocks = null)
                : base(handler, variableName) { this.ParentTGIBlocks = ParentTGIBlocks; this.tgiIndex = tgiIndex; }
            #endregion
        ...
        public class TC04_Single : ComplateElement
        {
            ...
            #region Constructors
            internal TC04_Single(EventHandler handler, string variableName, Stream s) : base(handler, variableName, s) { }
            public TC04_Single(EventHandler handler) : this(handler, 0, "FloatVariable", 0f) { }
            public TC04_Single(EventHandler handler, TC04_Single basis) : this(handler, 0, basis.variableName, basis.unknown1) { }
            public TC04_Single(EventHandler handler, byte unused, string variableName, float unknown1) : base(handler, variableName)
            {
        ...
        public class TC05_XY : ComplateElement
        {
            ...
            #region Constructors
            internal TC05_XY(EventHandler handler, string variableName, Stream s) : base(handler, variableName, s) { }
            public TC05_XY(EventHandler handler) : this(handler, 0, "XYVariable", 0f, 0f) { }
            public TC05_XY(EventHandler handler, TC05_XY basis) : this(handler, 0, basis.variableName, basis.unknown1, basis.unknown2) { }
            public TC05_XY(EventHandler handler, byte unused, string variableName, float unknown1, float unknown2) : base(handler, variableName)
            {
                this.unknown1 = unknown1;
        ...
        public class TC06_XYZ : ComplateElement
        {
            ...
            #region Constructors
            internal TC06_XYZ(EventHandler handler, string variableName, Stream s) : base(handler, variableName, s) { }
            public TC06_XYZ(EventHandler handler) : this(handler, 0, "XYZVariable", 0f, 0f, 0f) { }
            public TC06_XYZ(EventHandler handler, TC06_XYZ basis) : this(handler, 0, basis.variableName, basis.unknown1, basis.unknown2, basis.unknown3) { }
            public TC06_XYZ(EventHandler handler, byte unused, string variableName, float unknown1, float unknown2,
                float unknown3) : base(handler, variableName)
            {
                this.unknown1 = unknown1;
                this.unknown2 = unknown2;
        ...
        public class TC07_Boolean : ComplateElement
        {
            ...
            #region Constructors
            internal TC07_Boolean(EventHandler handler, string variableName, Stream s) : base(handler, variableName, s) { }
            public TC07_Boolean(EventHandler handler) : this(handler, 0, "TFVariable", false) { }
            public TC07_Boolean(EventHandler handler, TC07_Boolean basis) : this(handler, 0, basis.variableName, basis.unknown1 != 0) { }
            public TC07_Boolean(EventHandler handler, byte unused, string variableName, bool value) : base(handler, variableName)
            {
        ...
        public class ComplateList : DependentList<ComplateElement>
        {
            ...
            public ComplateList(EventHandler handler, IEnumerable<ComplateElement> ltc, DependentList<TGIBlock> ParentTGIBlocks = null)
                : this(null, ParentTGIBlocks) { elementHandler = handler; foreach (ComplateElement t in ltc) this.Add((ComplateElement)t.Clone(null)); this.handler = handler; }
            #endregion

            #region Data I/O
            protected override ComplateElement CreateElement(Stream s)
            {
                return ComplateElement.CreateTypeCode(elementHandler, ComplateString.Read(s), new BinaryReader(s).ReadByte(), s, _ParentTGIBlocks);
            }
            ...
            public override void Add(Type elementType)
            {
                ...
                if (typeof(TC03_TGIIndex).IsAssignableFrom(elementType))
                    newElement = new TC03_TGIIndex(elementHandler, _ParentTGIBlocks);
                else
                    newElement = Activator.CreateInstance(elementType, new object[] { elementHandler, }) as ComplateElement;
                base.Add(newElement);
            }
        }
        #endregion
            ...
            IComparable<MaterialBlock>, IEqualityComparer<MaterialBlock>, IEquatable<MaterialBlock>
        {
            ...
            #region Constructors
            public MaterialBlock(EventHandler handler, DependentList<TGIBlock> ParentTGIBlocks = null)
                : base(handler)
            {
            ...
            internal MaterialBlock(EventHandler handler, Stream s, DependentList<TGIBlock> ParentTGIBlocks = null)
                : base(handler) { _ParentTGIBlocks = ParentTGIBlocks; Parse(s); }

            public MaterialBlock(EventHandler handler, MaterialBlock basis,
                DependentList<TGIBlock> ParentTGIBlocks = null)
                : this(handler, basis.complateXMLIndex, basis.name, basis.pattern, basis.complateList, basis.mbList, ParentTGIBlocks ?? basis._ParentTGIBlocks) { }

            public MaterialBlock(EventHandler handler, byte xmlindex, string unknown1, string unknown2,
            ...
            public object Clone() { return new MaterialBlock(handler, this); }
        ...
        public class MaterialBlockList : DependentList<MaterialBlock>
        {
            ...
            {
                get { return _ParentTGIBlocks; }
                set { if (_ParentTGIBlocks != value) { _ParentTGIBlocks = value; foreach (MaterialBlock i in this) i.ParentTGIBlocks = _ParentTGIBlocks; } }
            }
            ...
            public MaterialBlockList(EventHandler handler, IEnumerable<MaterialBlock> lmb, DependentList<TGIBlock> ParentTGIBlocks = null)
                : this(null, ParentTGIBlocks) { elementHandler = handler; foreach (MaterialBlock t in lmb) this.Add((MaterialBlock)t.Clone(null)); this.handler = handler; }
            #endregion

            #region Data I/O
            protected override MaterialBlock CreateElement(Stream s) { return new MaterialBlock(elementHandler, s, _ParentTGIBlocks); }
            protected override void WriteElement(Stream s, MaterialBlock element) { element.UnParse(s); }
            #endregion

            public override void Add() { this.Add(new MaterialBlock(handler, _ParentTGIBlocks)); }
            ...
            IComparable<Material>, IEqualityComparer<Material>, IEquatable<Material>
        {
            ...
            #region Constructors
            public Material(EventHandler handler)
                : base(handler)
            {
                list = new TGIBlockList(handler);
                mb = new MaterialBlock(handler, list);
            }
            internal Material(EventHandler handler, Stream s) : base(handler) { Parse(s); }
            public Material(EventHandler handler, Material basis)
                : this(handler,
                basis.materialType, basis.unknown1, basis.unknown2,
                basis.mb, basis.list, basis.unknown3) { }
            public Material(EventHandler handler, byte materialType, uint unknown1, ushort unknown2,
                ...
                : base(handler)
            {
                ...
                this.mb = mb == null ? null : new MaterialBlock(handler, mb, this.list);
                this.unknown3 = unknown3;
            }
            #endregion
            ...
            protected virtual void Parse(Stream s)
            {
                ...
                mb = new MaterialBlock(handler, s);
            ...
            public virtual object Clone() { return new Material(handler, this); }
            ...
            [ElementPriority(4)]
            public MaterialBlock MaterialBlock { get { return mb; } set { if (mb != value) { mb = new MaterialBlock(handler, value, list); OnElementChanged(); } } }
            [ElementPriority(5)]
        ...
        public class MaterialList : DependentList<Material>
        {
            ...
            #region Data I/O
            protected override Material CreateElement(Stream s) { return new Material(elementHandler, s); }
        ...
        [ElementPriority(11)]
        public Common CommonBlock { get { return common; } set { if (common != value) { common = new Common(OnResourceChanged, value); OnResourceChanged(this, EventArgs.Empty); } } }
    ...
    public abstract class CatalogResourceTGIBlockList : CatalogResource
    {
        ...
        #region Constructors
        public CatalogResourceTGIBlockList(Stream s) : base(s)
        {
        ...
        public CatalogResourceTGIBlockList(uint version, Common common, IEnumerable<TGIBlock> tgibl) : base(version, common)
        {
            // http://private/s3pi/index.php?topic=1368.0
            // As index values are defaulted to zero, we should have a zeroth entry.
            if (tgibl == null)
