...
namespace Regul.S3PI.Resources.CatalogResource
{
    public class RoofPatternCatalogResource : CatalogResourceTGIBlockList
    {
        ...
        #region Constructors
        public RoofPatternCatalogResource(Stream s) : base(s) { }
        public RoofPatternCatalogResource(Stream unused, RoofPatternCatalogResource basis)
        ...
        public RoofPatternCatalogResource(uint version, Common common,
        ...
        protected override void Parse(Stream s)
        {
            ...
            if (this.GetType().Equals(typeof(RoofPatternCatalogResource)) && s.Position != s.Length)
