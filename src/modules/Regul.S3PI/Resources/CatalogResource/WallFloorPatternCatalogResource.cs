...
namespace Regul.S3PI.Resources.CatalogResource
{
    public class WallFloorPatternCatalogResource : CatalogResourceTGIBlockList
    {
        ...
        #region Constructors
        public WallFloorPatternCatalogResource(Stream s) : base(s) { }
        public WallFloorPatternCatalogResource(Stream unused, WallFloorPatternCatalogResource basis)
            : this(basis.version,
            basis.materialList,
            basis.common,
            basis.patternType,
            ...
            IComparable<WallFloorPatternMaterial>, IEqualityComparer<WallFloorPatternMaterial>, IEquatable<WallFloorPatternMaterial>
        {
            ...
            #region Constructors
            internal WallFloorPatternMaterial(EventHandler handler) : base(handler) { }
            internal WallFloorPatternMaterial(EventHandler handler, Stream s) : base(handler, s) { }
            public WallFloorPatternMaterial(EventHandler handler, WallFloorPatternMaterial basis)
                : base(handler, basis) { this.unknown4 = basis.unknown4; this.unknown5 = basis.unknown5; this.unknown6 = basis.unknown6; }
            public WallFloorPatternMaterial(EventHandler handler, byte materialType, uint unknown1, ushort unknown2,
                ...
                uint unknown6)
                : base(handler, materialType, unknown1, unknown2, mb, ltgib, unknown3) { this.unknown4 = unknown4; this.unknown5 = unknown5; this.unknown6 = unknown6; }
            #endregion
            ...
            public override object Clone() { return new WallFloorPatternMaterial(handler, this); }
        ...
        public class WallFloorPatternMaterialList : DependentList<WallFloorPatternMaterial>
        {
            ...
            #region Data I/O
            protected override WallFloorPatternMaterial CreateElement(Stream s) { return new WallFloorPatternMaterial(elementHandler, s); }
