...
namespace Regul.S3PI.Resources.CatalogResource
{
    public class TerrainGeometryWaterBrushCatalogResource : CatalogResource
    {
        ...
        #region Constructors
        public TerrainGeometryWaterBrushCatalogResource(Stream s) : base(s) { }
        public TerrainGeometryWaterBrushCatalogResource(Stream unused, TerrainGeometryWaterBrushCatalogResource basis)
            : this(basis.version,
                basis.brushVersion,
                basis.common,
        ...
        protected override Stream UnParse()
        {
            ...
            if (profileTexture == null) profileTexture = new TGIBlock(OnResourceChanged);
