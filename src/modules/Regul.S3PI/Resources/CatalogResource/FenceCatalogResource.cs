...
namespace Regul.S3PI.Resources.CatalogResource
{
    public class FenceCatalogResource : CatalogResourceTGIBlockList
    {
        ...
        #region Constructors
        public FenceCatalogResource(Stream s) : base(s) { }
        public FenceCatalogResource(Stream unused, FenceCatalogResource basis)
            : this(basis.version,
            basis.materialList,
        ...
        protected override void Parse(Stream s)
        {
            ...
            if (this.GetType().Equals(typeof(FenceCatalogResource)) && s.Position != s.Length)
