...
namespace Regul.S3PI.Resources.GenericRCOLResource
{
    ...
    public class GenericRCOLResource : AResource
    {
        ...
        public class ChunkEntry : AHandlerElement, IEquatable<ChunkEntry>
        {
            ...
            public ChunkEntry(EventHandler handler, ChunkEntry basis)
                : this(handler, basis.tgiBlock, basis.rcolBlock) { }
            ...
            public ChunkEntry(EventHandler handler, TGIBlock tgiBlock, ARCOLBlock rcolBlock)
                : base(handler)
            {
            ...
            public string Value
            {
                get
                {
                    ...
                    if (AApiVersionedFields.GetContentFields(rcolBlock.GetType()).Contains("Value") &&
                            typeof(string).IsAssignableFrom(AApiVersionedFields.GetContentFieldTypes(rcolBlock.GetType())["Value"]))
        ...
        public class ChunkEntryList : DependentList<ChunkEntry>
        {
            ...
            public DependentList<TGIBlock> ParentTGIBlocks
            {
                ...
                set { if (_ParentTGIBlocks != value) { _ParentTGIBlocks = value; foreach (ChunkEntry i in this) i.ParentTGIBlocks = _ParentTGIBlocks; } }
            }
            ...
            IComparer<ChunkReference>, IComparable<ChunkReference>
        {
            ...
            {
                return new ChunkReference(null, CreateReferenceHelper(rcol, rk));
            }
    ...
    public class GenericRCOLResourceHandler : AResourceHandler
    {
        ...
        static GenericRCOLResourceHandler()
        {
            ...
            foreach (string path in Directory.GetFiles(folder, "*.dll"))
            {
                ...
                try
                {
                    ...
                    foreach (Type t in types)
                    {
                        ...
                        try
                        {
                            ConstructorInfo ctor = t.GetConstructor(new Type[] { typeof(EventHandler), typeof(Stream), });
            ...
            StringReader sr = new StringReader(Properties.Resources.RCOLResources);
        ...
        {
            Type[] types = new Type[] { typeof(EventHandler), };
        ...
        {
            Type[] types = new Type[] { typeof(EventHandler), typeof(Stream), };
            object[] args = new object[] { handler, s };
            if (GenericRCOLResourceHandler.typeRegistry.ContainsKey(type))
            {
                Type t = GenericRCOLResourceHandler.typeRegistry[type];
                return (ARCOLBlock)t.GetConstructor(types).Invoke(args);
