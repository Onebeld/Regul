...
namespace System.Security.Cryptography
{
    ...
    public class Sims3PackCRC : HashAlgorithm
    {
        ...
        public Sims3PackCRC(ulong seed = 0x00FFFFFFFFFFFFFF) { _seed64 = seed; Initialize(); }
        ...
        {
            ulong crc = SwapEndian(_hash64);
            for (int i = ibStart; i < cbSize; i++)
                crc = (crc >> 8) ^ Table[(array[i] ^ crc) & 0xFF];
            _hash64 = SwapEndian(crc);
        }
        ...
        protected override byte[] HashFinal() { HashSizeValue = 64; HashValue = BitConverter.GetBytes(~_hash64); return HashValue; }

        /// <summary>
        /// Initialize the Sims3PackCRC by setting the current CRC value to the seed.
        /// </summary>
        public override void Initialize() { _hash64 = _seed64; }
        #endregion
